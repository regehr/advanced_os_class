...
int main(void){
  ...
  if(gettime(&msec,&sec)<0){
    printf(1,"Error on gettime");
  50:	c7 44 24 04 f5 07 00 	movl   $0x7f5,0x4(%esp)
  57:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 37a:	f7 f7                	div    %edi
 37c:	0f b6 92 23 08 00 00 	movzbl 0x823(%edx),%edx
...
putc(int fd, char c)
{
 ...
 510:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        ap++;
        if(s == 0)
 513:	b9 1c 08 00 00       	mov    $0x81c,%ecx
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
...
free(void *ap)
{
 ...
 5d1:	a1 3c 08 00 00       	mov    0x83c,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 61f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 621:	a3 3c 08 00 00       	mov    %eax,0x83c
}
 626:	5b                   	pop    %ebx
 627:	5e                   	pop    %esi
 628:	5f                   	pop    %edi
 ...
 64b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 64d:	a3 3c 08 00 00       	mov    %eax,0x83c
}
 652:	5b                   	pop    %ebx
 653:	5e                   	pop    %esi
 654:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 669:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 66c:	8b 0d 3c 08 00 00    	mov    0x83c,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 69c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 6a0:	3b 05 3c 08 00 00    	cmp    0x83c,%eax
 ...
 6bf:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 6c2:	89 0d 3c 08 00 00    	mov    %ecx,0x83c
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 702:	e8 c9 fe ff ff       	call   5d0 <free>
  return freep;
 707:	8b 0d 3c 08 00 00    	mov    0x83c,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 71c:	eb a4                	jmp    6c2 <malloc+0x62>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 71e:	c7 05 3c 08 00 00 34 	movl   $0x834,0x83c
 725:	08 00 00 
    base.s.size = 0;
 728:	b9 34 08 00 00       	mov    $0x834,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 72d:	c7 05 34 08 00 00 34 	movl   $0x834,0x834
 734:	08 00 00 
    base.s.size = 0;
 737:	c7 05 38 08 00 00 00 	movl   $0x0,0x838
 73e:	00 00 00 
...
struct ring_res ring_write_reserve(struct ring *r, int bytes)
{
 ...
 783:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  return ret;
 786:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
 78d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
 793:	5d                   	pop    %ebp
 794:	c2 04 00             	ret    $0x4
 797:	89 f6                	mov    %esi,%esi
 799:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

000007a0 <ring_write_notify>:
...
struct ring_res ring_read_reserve(struct ring *r, int bytes)
{
 ...
 7b3:	8b 45 08             	mov    0x8(%ebp),%eax
  struct ring_res ret = {0, 0};
  return ret;
 7b6:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
 7bd:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
 7c3:	5d                   	pop    %ebp
 7c4:	c2 04 00             	ret    $0x4
 7c7:	89 f6                	mov    %esi,%esi
 7c9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

000007d0 <ring_read_notify>:
