...
grep(char *pattern, int fd)
{
 ...
 187:	05 40 0b 00 00       	add    $0xb40,%eax
 ...
 1a6:	be 40 0b 00 00       	mov    $0xb40,%esi
 1ab:	90                   	nop
 ...
 202:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    if(p == buf)
 208:	81 fe 40 0b 00 00    	cmp    $0xb40,%esi
...
main(int argc, char *argv[])
{
 ...
 2da:	c7 44 24 04 d8 0a 00 	movl   $0xad8,0x4(%esp)
 2e1:	00 
 ...
 30d:	8d 76 00             	lea    0x0(%esi),%esi
{
  ...
  if(argc <= 1){
    printf(2, "usage: grep pattern [file ...]\n");
 310:	c7 44 24 04 b8 0a 00 	movl   $0xab8,0x4(%esp)
 317:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 63a:	f7 f7                	div    %edi
 63c:	0f b6 92 f5 0a 00 00 	movzbl 0xaf5(%edx),%edx
...
putc(int fd, char c)
{
 ...
 7d0:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        ap++;
        if(s == 0)
 7d3:	b9 ee 0a 00 00       	mov    $0xaee,%ecx
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
...
free(void *ap)
{
 ...
 891:	a1 28 0b 00 00       	mov    0xb28,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 8df:	89 08                	mov    %ecx,(%eax)
  freep = p;
 8e1:	a3 28 0b 00 00       	mov    %eax,0xb28
}
 8e6:	5b                   	pop    %ebx
 8e7:	5e                   	pop    %esi
 8e8:	5f                   	pop    %edi
 ...
 90b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 90d:	a3 28 0b 00 00       	mov    %eax,0xb28
}
 912:	5b                   	pop    %ebx
 913:	5e                   	pop    %esi
 914:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 929:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 92c:	8b 0d 28 0b 00 00    	mov    0xb28,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 95c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 960:	3b 05 28 0b 00 00    	cmp    0xb28,%eax
 ...
 97f:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 982:	89 0d 28 0b 00 00    	mov    %ecx,0xb28
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 9c2:	e8 c9 fe ff ff       	call   890 <free>
  return freep;
 9c7:	8b 0d 28 0b 00 00    	mov    0xb28,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 9dc:	eb a4                	jmp    982 <malloc+0x62>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 9de:	c7 05 28 0b 00 00 20 	movl   $0xb20,0xb28
 9e5:	0b 00 00 
    base.s.size = 0;
 9e8:	b9 20 0b 00 00       	mov    $0xb20,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 9ed:	c7 05 20 0b 00 00 20 	movl   $0xb20,0xb20
 9f4:	0b 00 00 
    base.s.size = 0;
 9f7:	c7 05 24 0b 00 00 00 	movl   $0x0,0xb24
 9fe:	00 00 00 
...
struct ring_res ring_write_reserve(struct ring *r, int bytes)
{
 ...
 a4d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
 a53:	5d                   	pop    %ebp
 a54:	c2 04 00             	ret    $0x4
 a57:	89 f6                	mov    %esi,%esi
 a59:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00000a60 <ring_write_notify>:
