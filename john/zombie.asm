...
printint(int fd, int xx, int base, int sgn)
{
 ...
 33a:	f7 f7                	div    %edi
 33c:	0f b6 92 bc 07 00 00 	movzbl 0x7bc(%edx),%edx
...
putc(int fd, char c)
{
 ...
 4d0:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        ap++;
        if(s == 0)
 4d3:	b9 b5 07 00 00       	mov    $0x7b5,%ecx
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
...
free(void *ap)
{
 ...
 591:	a1 d8 07 00 00       	mov    0x7d8,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5df:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5e1:	a3 d8 07 00 00       	mov    %eax,0x7d8
}
 5e6:	5b                   	pop    %ebx
 5e7:	5e                   	pop    %esi
 5e8:	5f                   	pop    %edi
 ...
 60b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 60d:	a3 d8 07 00 00       	mov    %eax,0x7d8
}
 612:	5b                   	pop    %ebx
 613:	5e                   	pop    %esi
 614:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 629:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 62c:	8b 0d d8 07 00 00    	mov    0x7d8,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 65c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 660:	3b 05 d8 07 00 00    	cmp    0x7d8,%eax
 ...
 67f:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 682:	89 0d d8 07 00 00    	mov    %ecx,0x7d8
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 6c2:	e8 c9 fe ff ff       	call   590 <free>
  return freep;
 6c7:	8b 0d d8 07 00 00    	mov    0x7d8,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6dc:	eb a4                	jmp    682 <malloc+0x62>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6de:	c7 05 d8 07 00 00 d0 	movl   $0x7d0,0x7d8
 6e5:	07 00 00 
    base.s.size = 0;
 6e8:	b9 d0 07 00 00       	mov    $0x7d0,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6ed:	c7 05 d0 07 00 00 d0 	movl   $0x7d0,0x7d0
 6f4:	07 00 00 
    base.s.size = 0;
 6f7:	c7 05 d4 07 00 00 00 	movl   $0x0,0x7d4
 6fe:	00 00 00 
...
struct ring_res ring_write_reserve(struct ring *r, int bytes)
{
 ...
 743:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  return ret;
 746:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
 74d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
 753:	5d                   	pop    %ebp
 754:	c2 04 00             	ret    $0x4
 757:	89 f6                	mov    %esi,%esi
 759:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00000760 <ring_write_notify>:
