...
wc(int fd, char *name)
{
  ...
  50:	7e 38                	jle    8a <wc+0x8a>
      c++;
      if(buf[i] == '\n')
  52:	0f be 83 a0 09 00 00 	movsbl 0x9a0(%ebx),%eax
        l++;
  59:	31 d2                	xor    %edx,%edx
      if(strchr(" \r\t\n\v", buf[i]))
  5b:	c7 04 24 25 09 00 00 	movl   $0x925,(%esp)
  inword = 0;
  while((n = read(fd, buf, sizeof(buf))) > 0){
    for(i=0; i<n; i++){
      c++;
  ...
  9b:	c7 44 24 04 3b 09 00 	movl   $0x93b,0x4(%esp)
  a2:	00 
  ...
  if(n < 0){
    printf(1, "wc: read error\n");
  c9:	c7 44 24 04 2b 09 00 	movl   $0x92b,0x4(%esp)
  d0:	00 
...
main(int argc, char *argv[])
{
 ...
 15a:	c7 44 24 04 48 09 00 	movl   $0x948,0x4(%esp)
 161:	00 
...
main(int argc, char *argv[])
{
  ...
  if(argc <= 1){
    wc(0, "");
 178:	c7 44 24 04 3a 09 00 	movl   $0x93a,0x4(%esp)
 17f:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4aa:	f7 f7                	div    %edi
 4ac:	0f b6 92 63 09 00 00 	movzbl 0x963(%edx),%edx
...
putc(int fd, char c)
{
 ...
 640:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        ap++;
        if(s == 0)
 643:	b9 5c 09 00 00       	mov    $0x95c,%ecx
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
...
free(void *ap)
{
 ...
 701:	a1 88 09 00 00       	mov    0x988,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 74f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 751:	a3 88 09 00 00       	mov    %eax,0x988
}
 756:	5b                   	pop    %ebx
 757:	5e                   	pop    %esi
 758:	5f                   	pop    %edi
 ...
 77b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 77d:	a3 88 09 00 00       	mov    %eax,0x988
}
 782:	5b                   	pop    %ebx
 783:	5e                   	pop    %esi
 784:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 799:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 79c:	8b 0d 88 09 00 00    	mov    0x988,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 7cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 7d0:	3b 05 88 09 00 00    	cmp    0x988,%eax
 ...
 7ef:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 7f2:	89 0d 88 09 00 00    	mov    %ecx,0x988
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 832:	e8 c9 fe ff ff       	call   700 <free>
  return freep;
 837:	8b 0d 88 09 00 00    	mov    0x988,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 84c:	eb a4                	jmp    7f2 <malloc+0x62>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 84e:	c7 05 88 09 00 00 80 	movl   $0x980,0x988
 855:	09 00 00 
    base.s.size = 0;
 858:	b9 80 09 00 00       	mov    $0x980,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 85d:	c7 05 80 09 00 00 80 	movl   $0x980,0x980
 864:	09 00 00 
    base.s.size = 0;
 867:	c7 05 84 09 00 00 00 	movl   $0x0,0x984
 86e:	00 00 00 
...
struct ring_res ring_write_reserve(struct ring *r, int bytes)
{
 ...
 8b3:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  return ret;
 8b6:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
 8bd:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
 8c3:	5d                   	pop    %ebp
 8c4:	c2 04 00             	ret    $0x4
 8c7:	89 f6                	mov    %esi,%esi
 8c9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

000008d0 <ring_write_notify>:
...
struct ring_res ring_read_reserve(struct ring *r, int bytes)
{
 ...
 8e3:	8b 45 08             	mov    0x8(%ebp),%eax
  struct ring_res ret = {0, 0};
  return ret;
 8e6:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
 8ed:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
 8f3:	5d                   	pop    %ebp
 8f4:	c2 04 00             	ret    $0x4
 8f7:	89 f6                	mov    %esi,%esi
 8f9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00000900 <ring_read_notify>:
