...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fa:	0f b6 80 64 08 00 00 	movzbl 0x864(%eax),%eax
...
free(void *ap)
{
 ...
 627:	a1 80 08 00 00       	mov    0x880,%eax
...
free(void *ap)
{
 ...
 6e8:	a3 80 08 00 00       	mov    %eax,0x880
}
 6ed:	c9                   	leave  
 6ee:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 73b:	e8 d8 fe ff ff       	call   618 <free>
  return freep;
 740:	a1 80 08 00 00       	mov    0x880,%eax
}
 745:	c9                   	leave  
 746:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 759:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((prevp = freep) == 0){
 75c:	a1 80 08 00 00       	mov    0x880,%eax
 761:	89 45 f0             	mov    %eax,-0x10(%ebp)
 764:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 768:	75 23                	jne    78d <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 76a:	c7 45 f0 78 08 00 00 	movl   $0x878,-0x10(%ebp)
 771:	8b 45 f0             	mov    -0x10(%ebp),%eax
 774:	a3 80 08 00 00       	mov    %eax,0x880
 779:	a1 80 08 00 00       	mov    0x880,%eax
 77e:	a3 78 08 00 00       	mov    %eax,0x878
    base.s.size = 0;
 783:	c7 05 7c 08 00 00 00 	movl   $0x0,0x87c
 78a:	00 00 00 
  }
 ...
 7e0:	a3 80 08 00 00       	mov    %eax,0x880
      return (void*)(p + 1);
 ...
 7eb:	eb 38                	jmp    825 <malloc+0xde>
    ...
    if(p == freep)
 7ed:	a1 80 08 00 00       	mov    0x880,%eax
