...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
      ...
      22:	ff 24 85 c8 13 00 00 	jmp    *0x13c8(,%eax,4)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
      ...
      d2:	c7 04 24 c8 14 00 00 	movl   $0x14c8,(%esp)
     ...
     150:	83 c3 01             	add    $0x1,%ebx
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     15a:	c7 04 24 c8 14 00 00 	movl   $0x14c8,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     1aa:	c7 04 24 c8 14 00 00 	movl   $0x14c8,(%esp)
  ...
  *ps = s;
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     1eb:	c7 04 24 ce 14 00 00 	movl   $0x14ce,(%esp)
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     20d:	c7 04 24 c8 14 00 00 	movl   $0x14c8,(%esp)
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     409:	c7 44 24 04 61 14 00 	movl   $0x1461,0x4(%esp)
     410:	00 
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     440:	c7 44 24 08 15 14 00 	movl   $0x1415,0x8(%esp)
     447:	00 
     ...
     47c:	89 3c 24             	mov    %edi,(%esp)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     499:	c7 04 24 f8 13 00 00 	movl   $0x13f8,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     51f:	c7 44 24 08 18 14 00 	movl   $0x1418,0x8(%esp)
     526:	00 
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
     576:	c7 44 24 08 2f 14 00 	movl   $0x142f,0x8(%esp)
     57d:	00 
    ...
    if(tok != 'a')
     ...
     5af:	74 0c                	je     5bd <parseexec+0xad>
      panic("syntax");
     5b1:	c7 04 24 1a 14 00 00 	movl   $0x141a,(%esp)
    ...
    if(argc >= MAXARGS)
     ...
     5d4:	7e 8a                	jle    560 <parseexec+0x50>
      panic("too many args");
     5d6:	c7 04 24 21 14 00 00 	movl   $0x1421,(%esp)
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     651:	c7 44 24 08 34 14 00 	movl   $0x1434,0x8(%esp)
     658:	00 
...
parseline(char **ps, char *es)
{
  ...
  cmd = parsepipe(ps, es);
  while(peek(ps, es, "&")){
     706:	c7 44 24 08 36 14 00 	movl   $0x1436,0x8(%esp)
     70d:	00 
  ...
  if(peek(ps, es, ";")){
     71e:	c7 44 24 08 32 14 00 	movl   $0x1432,0x8(%esp)
     725:	00 
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     795:	c7 44 24 08 18 14 00 	movl   $0x1418,0x8(%esp)
     79c:	00 
  ...
  if(!peek(ps, es, ")"))
     7d9:	c7 44 24 08 54 14 00 	movl   $0x1454,0x8(%esp)
     7e0:	00 
  ...
  if(!peek(ps, es, ")"))
    ...
    panic("syntax - missing )");
     7f3:	c7 04 24 43 14 00 00 	movl   $0x1443,(%esp)
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
    panic("parseblock");
     838:	c7 04 24 38 14 00 00 	movl   $0x1438,(%esp)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     874:	c7 44 24 08 83 14 00 	movl   $0x1483,0x8(%esp)
     87b:	00 
     87c:	89 5c 24 04          	mov    %ebx,0x4(%esp)
{
  ...
  if(s != es){
    ...
    printf(2, "leftovers: %s\n", s);
     ...
     898:	c7 44 24 04 56 14 00 	movl   $0x1456,0x4(%esp)
     89f:	00 
     8a0:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
     8a7:	e8 04 07 00 00       	call   fb0 <printf>
    panic("syntax");
     8ac:	c7 04 24 1a 14 00 00 	movl   $0x141a,(%esp)
     ...
     8e2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
{
  ...
  if(pid == -1)
    panic("fork");
     ...
     8eb:	c7 04 24 65 14 00 00 	movl   $0x1465,(%esp)
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     912:	c7 44 24 04 6a 14 00 	movl   $0x146a,0x4(%esp)
     919:	00 
...
runcmd(struct cmd *cmd)
{
  ...
  default:
    panic("runcmd");
     973:	c7 04 24 6d 14 00 00 	movl   $0x146d,(%esp)
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     998:	c7 44 24 04 74 14 00 	movl   $0x1474,0x4(%esp)
     99f:	00 
  ...
  switch(cmd->type){
     ...
     9ba:	ff 24 85 e0 13 00 00 	jmp    *0x13e0(,%eax,4)
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     b23:	c7 44 24 04 84 14 00 	movl   $0x1484,0x4(%esp)
     b2a:	00 
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
      panic("pipe");
     b40:	c7 04 24 94 14 00 00 	movl   $0x1494,(%esp)
...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     b77:	00 
     b78:	c7 04 24 99 14 00 00 	movl   $0x1499,(%esp)
    ...
    if(fork1() == 0)
      runcmd(parsecmd(buf));
     b97:	c7 04 24 e0 14 00 00 	movl   $0x14e0,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     bb7:	00 
     bb8:	c7 04 24 e0 14 00 00 	movl   $0x14e0,(%esp)
     bbf:	e8 3c fd ff ff       	call   900 <getcmd>
     bc4:	85 c0                	test   %eax,%eax
     bc6:	78 70                	js     c38 <main+0xd8>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     bc8:	80 3d e0 14 00 00 63 	cmpb   $0x63,0x14e0
     bcf:	75 09                	jne    bda <main+0x7a>
     bd1:	80 3d e1 14 00 00 64 	cmpb   $0x64,0x14e1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     be8:	80 3d e2 14 00 00 20 	cmpb   $0x20,0x14e2
     bef:	90                   	nop
     bf0:	75 e8                	jne    bda <main+0x7a>
      // Clumsy but will have to do for now.
      // Chdir has no effect on the parent if run in the child.
      buf[strlen(buf)-1] = 0;  // chop \n
     bf2:	c7 04 24 e0 14 00 00 	movl   $0x14e0,(%esp)
     bf9:	e8 c2 00 00 00       	call   cc0 <strlen>
      if(chdir(buf+3) < 0)
     bfe:	c7 04 24 e3 14 00 00 	movl   $0x14e3,(%esp)
  // Read and run input commands.
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      // Clumsy but will have to do for now.
      // Chdir has no effect on the parent if run in the child.
      buf[strlen(buf)-1] = 0;  // chop \n
     c05:	c6 80 df 14 00 00 00 	movb   $0x0,0x14df(%eax)
      if(chdir(buf+3) < 0)
     c0c:	e8 c7 02 00 00       	call   ed8 <chdir>
     c11:	85 c0                	test   %eax,%eax
     c13:	79 9b                	jns    bb0 <main+0x50>
        printf(2, "cannot cd %s\n", buf+3);
     c15:	c7 44 24 08 e3 14 00 	movl   $0x14e3,0x8(%esp)
     c1c:	00 
     c1d:	c7 44 24 04 a1 14 00 	movl   $0x14a1,0x4(%esp)
     c24:	00 
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f4a:	f7 f7                	div    %edi
     f4c:	0f b6 92 b6 14 00 00 	movzbl 0x14b6(%edx),%edx
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    10e0:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        ap++;
        if(s == 0)
    10e3:	b9 af 14 00 00       	mov    $0x14af,%ecx
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    11a1:	a1 4c 15 00 00       	mov    0x154c,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  freep = p;
    11f1:	a3 4c 15 00 00       	mov    %eax,0x154c
}
    11f6:	5b                   	pop    %ebx
    11f7:	5e                   	pop    %esi
    11f8:	5f                   	pop    %edi
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    121d:	a3 4c 15 00 00       	mov    %eax,0x154c
}
    1222:	5b                   	pop    %ebx
    1223:	5e                   	pop    %esi
    1224:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    123c:	8b 0d 4c 15 00 00    	mov    0x154c,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
    ...
    if(p == freep)
    1270:	3b 05 4c 15 00 00    	cmp    0x154c,%eax
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    128f:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
    1292:	89 0d 4c 15 00 00    	mov    %ecx,0x154c
      return (void*)(p + 1);
...
morecore(uint nu)
{
  ...
  return freep;
    12d7:	8b 0d 4c 15 00 00    	mov    0x154c,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    12ee:	c7 05 4c 15 00 00 44 	movl   $0x1544,0x154c
    12f5:	15 00 00 
    base.s.size = 0;
    12f8:	b9 44 15 00 00       	mov    $0x1544,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    12fd:	c7 05 44 15 00 00 44 	movl   $0x1544,0x1544
    1304:	15 00 00 
    base.s.size = 0;
    1307:	c7 05 48 15 00 00 00 	movl   $0x0,0x1548
    130e:	00 00 00 
...
struct ring_res ring_write_reserve(struct ring *r, int bytes)
{
  ...
  return ret;
    1356:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    135d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
    1363:	5d                   	pop    %ebp
    1364:	c2 04 00             	ret    $0x4
    1367:	89 f6                	mov    %esi,%esi
    1369:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00001370 <ring_write_notify>:
...
void ring_write_notify(struct ring *r, int bytes)
{
    ...
    1373:	5d                   	pop    %ebp
    1374:	c3                   	ret    
    1375:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    1379:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00001380 <ring_read_reserve>:
...
struct ring_res ring_read_reserve(struct ring *r, int bytes)
{
  ...
  struct ring_res ret = {0, 0};
  return ret;
    1386:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    138d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
    1393:	5d                   	pop    %ebp
    1394:	c2 04 00             	ret    $0x4
    1397:	89 f6                	mov    %esi,%esi
    1399:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

000013a0 <ring_read_notify>:
