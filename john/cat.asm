...
cat(int fd)
{
  ...
  14:	c7 44 24 04 00 09 00 	movl   $0x900,0x4(%esp)
  1b:	00 
...
cat(int fd)
{
  ...
  2f:	00 
  30:	c7 44 24 04 00 09 00 	movl   $0x900,0x4(%esp)
  37:	00 
  ...
  if(n < 0){
    printf(1, "cat: read error\n");
  4d:	c7 44 24 04 95 08 00 	movl   $0x895,0x4(%esp)
  54:	00 
  55:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  5c:	e8 1f 04 00 00       	call   480 <printf>
    exit();
  61:	e8 d2 02 00 00       	call   338 <exit>
...
main(int argc, char *argv[])
{
  ...
  d2:	c7 44 24 04 a6 08 00 	movl   $0x8a6,0x4(%esp)
  d9:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41a:	f7 f7                	div    %edi
 41c:	0f b6 92 c2 08 00 00 	movzbl 0x8c2(%edx),%edx
...
putc(int fd, char c)
{
 ...
 5b0:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        ap++;
        if(s == 0)
 5b3:	b9 bb 08 00 00       	mov    $0x8bb,%ecx
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
...
free(void *ap)
{
 ...
 671:	a1 e8 08 00 00       	mov    0x8e8,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 6bf:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6c1:	a3 e8 08 00 00       	mov    %eax,0x8e8
}
 6c6:	5b                   	pop    %ebx
 6c7:	5e                   	pop    %esi
 6c8:	5f                   	pop    %edi
 ...
 6eb:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 6ed:	a3 e8 08 00 00       	mov    %eax,0x8e8
}
 6f2:	5b                   	pop    %ebx
 6f3:	5e                   	pop    %esi
 6f4:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 709:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 70c:	8b 0d e8 08 00 00    	mov    0x8e8,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 73c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 740:	3b 05 e8 08 00 00    	cmp    0x8e8,%eax
 ...
 75f:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 762:	89 0d e8 08 00 00    	mov    %ecx,0x8e8
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 7a2:	e8 c9 fe ff ff       	call   670 <free>
  return freep;
 7a7:	8b 0d e8 08 00 00    	mov    0x8e8,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7bc:	eb a4                	jmp    762 <malloc+0x62>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7be:	c7 05 e8 08 00 00 e0 	movl   $0x8e0,0x8e8
 7c5:	08 00 00 
    base.s.size = 0;
 7c8:	b9 e0 08 00 00       	mov    $0x8e0,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7cd:	c7 05 e0 08 00 00 e0 	movl   $0x8e0,0x8e0
 7d4:	08 00 00 
    base.s.size = 0;
 7d7:	c7 05 e4 08 00 00 00 	movl   $0x0,0x8e4
 7de:	00 00 00 
