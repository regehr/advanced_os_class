...
main(int argc, char **argv)
{
  ...
  if(argc < 1){
    printf(2, "usage: kill pid...\n");
  40:	c7 44 24 04 e5 07 00 	movl   $0x7e5,0x4(%esp)
  47:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 36a:	f7 f7                	div    %edi
 36c:	0f b6 92 00 08 00 00 	movzbl 0x800(%edx),%edx
...
putc(int fd, char c)
{
 ...
 500:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        ap++;
        if(s == 0)
 503:	b9 f9 07 00 00       	mov    $0x7f9,%ecx
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
...
free(void *ap)
{
 ...
 5c1:	a1 1c 08 00 00       	mov    0x81c,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 60f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 611:	a3 1c 08 00 00       	mov    %eax,0x81c
}
 616:	5b                   	pop    %ebx
 617:	5e                   	pop    %esi
 618:	5f                   	pop    %edi
 ...
 63b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 63d:	a3 1c 08 00 00       	mov    %eax,0x81c
}
 642:	5b                   	pop    %ebx
 643:	5e                   	pop    %esi
 644:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 659:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 65c:	8b 0d 1c 08 00 00    	mov    0x81c,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 68c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 690:	3b 05 1c 08 00 00    	cmp    0x81c,%eax
 ...
 6af:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 6b2:	89 0d 1c 08 00 00    	mov    %ecx,0x81c
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 6f2:	e8 c9 fe ff ff       	call   5c0 <free>
  return freep;
 6f7:	8b 0d 1c 08 00 00    	mov    0x81c,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 70c:	eb a4                	jmp    6b2 <malloc+0x62>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 70e:	c7 05 1c 08 00 00 14 	movl   $0x814,0x81c
 715:	08 00 00 
    base.s.size = 0;
 718:	b9 14 08 00 00       	mov    $0x814,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 71d:	c7 05 14 08 00 00 14 	movl   $0x814,0x814
 724:	08 00 00 
    base.s.size = 0;
 727:	c7 05 18 08 00 00 00 	movl   $0x0,0x818
 72e:	00 00 00 
...
struct ring_res ring_write_reserve(struct ring *r, int bytes)
{
 ...
 773:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  return ret;
 776:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
 77d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
 783:	5d                   	pop    %ebp
 784:	c2 04 00             	ret    $0x4
 787:	89 f6                	mov    %esi,%esi
 789:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00000790 <ring_write_notify>:
...
struct ring_res ring_read_reserve(struct ring *r, int bytes)
{
 ...
 7a3:	8b 45 08             	mov    0x8(%ebp),%eax
  struct ring_res ret = {0, 0};
  return ret;
 7a6:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
 7ad:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
 7b3:	5d                   	pop    %ebp
 7b4:	c2 04 00             	ret    $0x4
 7b7:	89 f6                	mov    %esi,%esi
 7b9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

000007c0 <ring_read_notify>:
...
void ring_write(struct ring *r, void *buf, int bytes)
{
 ...
 7d3:	5d                   	pop    %ebp
 7d4:	c3                   	ret    
 7d5:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
