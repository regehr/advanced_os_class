...
static unsigned long get_ms (void)
{
  ...
  if(gettime(&msec,&sec)<0){
    printf(1,"Error on gettime");
  d8:	c7 44 24 04 08 0c 00 	movl   $0xc08,0x4(%esp)
  df:	00 
 ...
 103:	83 ec 28             	sub    $0x28,%esp
{
 ...
 10e:	c7 44 24 10 19 0c 00 	movl   $0xc19,0x10(%esp)
 115:	00 
 116:	c7 44 24 04 98 0c 00 	movl   $0xc98,0x4(%esp)
 11d:	00 
...
void _srand48(struct _rand48_state *s, int seed)
{
  s->seed[0] = seed;
  s->seed[1] = 0;
 141:	66 c7 05 42 2d 00 00 	movw   $0x0,0x2d42
 148:	00 00 
  s->seed[2] = 0;
 14a:	66 c7 05 44 2d 00 00 	movw   $0x0,0x2d44
 151:	00 00 
  return ((int) _rand48_seed[2] << 15) + ((int) _rand48_seed[1] >> 1);
}
...
{
  s->seed[0] = seed;
 153:	66 a3 40 2d 00 00    	mov    %ax,0x2d40
  _srand48(&s2, getpid()+77);
 159:	e8 ca 05 00 00       	call   728 <getpid>
  s->seed[1] = 0;
 15e:	66 c7 05 48 2d 00 00 	movw   $0x0,0x2d48
 165:	00 00 
  s->seed[2] = 0;
 167:	66 c7 05 4a 2d 00 00 	movw   $0x0,0x2d4a
 16e:	00 00 
  Printf (1, "running in checked mode\n%s", "");
 170:	c7 44 24 08 97 0c 00 	movl   $0xc97,0x8(%esp)
 177:	00 
 178:	c7 44 24 04 24 0c 00 	movl   $0xc24,0x4(%esp)
 17f:	00 
...
void _srand48(struct _rand48_state *s, int seed)
{
 ...
 18a:	66 a3 46 2d 00 00    	mov    %ax,0x2d46
...
{
  reads++;
 1e8:	83 05 4c 2d 00 00 01 	addl   $0x1,0x2d4c
#ifdef CHECK
  len = (_lrand48(&s2)%len) + 1;
 1ef:	c7 04 24 46 2d 00 00 	movl   $0x2d46,(%esp)
 1f6:	e8 05 fe ff ff       	call   0 <_lrand48>
#endif
  return read (fd, buf, len);
 1fb:	c7 44 24 04 40 0d 00 	movl   $0xd40,0x4(%esp)
 202:	00 
 ...
 22a:	89 c6                	mov    %eax,%esi
{
 ...
 240:	c7 04 24 40 2d 00 00 	movl   $0x2d40,(%esp)
 247:	e8 b4 fd ff ff       	call   0 <_lrand48>
	Assert (buf[i] == expect);
 24c:	38 83 40 0d 00 00    	cmp    %al,0xd40(%ebx)
 252:	74 0f                	je     263 <main+0x133>
 254:	ba 6a 00 00 00       	mov    $0x6a,%edx
 259:	b8 60 0c 00 00       	mov    $0xc60,%eax
 ...
 26a:	e9 79 ff ff ff       	jmp    1e8 <main+0xb8>
{
 ...
 274:	b8 58 0c 00 00       	mov    $0xc58,%eax
 ...
 28b:	b8 46 0c 00 00       	mov    $0xc46,%eax
 ...
 2bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
	...
	if (last_pos < BLOCK_SIZE) {
	  buf[i] = buf[last_pos];
 2c0:	0f b6 83 40 0d 00 00 	movzbl 0xd40(%ebx),%eax
	  last_pos++;
 2c7:	83 c3 01             	add    $0x1,%ebx
	...
	if (last_pos < BLOCK_SIZE) {
	  buf[i] = buf[last_pos];
 2ca:	88 82 40 0d 00 00    	mov    %al,0xd40(%edx)
#endif
  do {
#ifdef CHECK
    {
 ...
 2e7:	c7 04 24 40 2d 00 00 	movl   $0x2d40,(%esp)
 2ee:	e8 0d fd ff ff       	call   0 <_lrand48>
 2f3:	8b 54 24 18          	mov    0x18(%esp),%edx
 2f7:	88 82 40 0d 00 00    	mov    %al,0xd40(%edx)
#endif
  do {
#ifdef CHECK
    {
...
{
  writes++;
 308:	83 05 50 2d 00 00 01 	addl   $0x1,0x2d50
#ifdef CHECK
  len = (_lrand48(&s2)%len) + 1;
 30f:	c7 04 24 46 2d 00 00 	movl   $0x2d46,(%esp)
 316:	e8 e5 fc ff ff       	call   0 <_lrand48>
#endif
  return write (fd, buf, len);
 31b:	c7 44 24 04 40 0d 00 	movl   $0xd40,0x4(%esp)
 322:	00 
 ...
 343:	85 c0                	test   %eax,%eax
{
 ...
 351:	0f 8e 61 ff ff ff    	jle    2b8 <main+0x188>
  Printf (1, "%d bytes written in %d calls to write()\n", bytes_wrote, writes);
 357:	a1 50 2d 00 00       	mov    0x2d50,%eax
 35c:	89 74 24 08          	mov    %esi,0x8(%esp)
 360:	c7 44 24 04 f0 0c 00 	movl   $0xcf0,0x4(%esp)
 367:	00 
 ...
 39b:	c7 44 24 04 82 0c 00 	movl   $0xc82,0x4(%esp)
 3a2:	00 
 ...
 3c1:	b8 71 0c 00 00       	mov    $0xc71,%eax
 ...
 3d5:	b8 3f 0c 00 00       	mov    $0xc3f,%eax
 ...
 3e9:	b8 4f 0c 00 00       	mov    $0xc4f,%eax
 ...
 3fa:	b8 4f 0c 00 00       	mov    $0xc4f,%eax
 ...
 40e:	b8 4f 0c 00 00       	mov    $0xc4f,%eax
 ...
 422:	b8 78 0c 00 00       	mov    $0xc78,%eax
 ...
 437:	a1 4c 2d 00 00       	mov    0x2d4c,%eax
 43c:	89 7c 24 08          	mov    %edi,0x8(%esp)
 440:	c7 44 24 04 c8 0c 00 	movl   $0xcc8,0x4(%esp)
 447:	00 
 ...
 471:	b8 4f 0c 00 00       	mov    $0xc4f,%eax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 78a:	f7 f7                	div    %edi
 78c:	0f b6 92 23 0d 00 00 	movzbl 0xd23(%edx),%edx
...
putc(int fd, char c)
{
 ...
 920:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        ap++;
        if(s == 0)
 923:	b9 1c 0d 00 00       	mov    $0xd1c,%ecx
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
...
free(void *ap)
{
 ...
 9e1:	a1 5c 2d 00 00       	mov    0x2d5c,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 a2f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 a31:	a3 5c 2d 00 00       	mov    %eax,0x2d5c
}
 a36:	5b                   	pop    %ebx
 a37:	5e                   	pop    %esi
 a38:	5f                   	pop    %edi
 ...
 a5b:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 a5d:	a3 5c 2d 00 00       	mov    %eax,0x2d5c
}
 a62:	5b                   	pop    %ebx
 a63:	5e                   	pop    %esi
 a64:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 a79:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 a7c:	8b 0d 5c 2d 00 00    	mov    0x2d5c,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 aac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 ab0:	3b 05 5c 2d 00 00    	cmp    0x2d5c,%eax
 ...
 acf:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 ad2:	89 0d 5c 2d 00 00    	mov    %ecx,0x2d5c
      return (void*)(p + 1);
...
morecore(uint nu)
{
 ...
 b12:	e8 c9 fe ff ff       	call   9e0 <free>
  return freep;
 b17:	8b 0d 5c 2d 00 00    	mov    0x2d5c,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 b2c:	eb a4                	jmp    ad2 <malloc+0x62>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 b2e:	c7 05 5c 2d 00 00 54 	movl   $0x2d54,0x2d5c
 b35:	2d 00 00 
    base.s.size = 0;
 b38:	b9 54 2d 00 00       	mov    $0x2d54,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 b3d:	c7 05 54 2d 00 00 54 	movl   $0x2d54,0x2d54
 b44:	2d 00 00 
    base.s.size = 0;
 b47:	c7 05 58 2d 00 00 00 	movl   $0x0,0x2d58
 b4e:	00 00 00 
...
struct ring_res ring_write_reserve(struct ring *r, int bytes)
{
 ...
 b93:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  return ret;
 b96:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
 b9d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
 ba3:	5d                   	pop    %ebp
