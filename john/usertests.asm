...
rand()
{
  randstate = randstate * 1664525 + 1013904223;
      10:	69 05 c8 54 00 00 0d 	imul   $0x19660d,0x54c8,%eax
      17:	66 19 00 
}
...
rand()
{
  randstate = randstate * 1664525 + 1013904223;
      ...
      23:	a3 c8 54 00 00       	mov    %eax,0x54c8
  return randstate;
}
      28:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
      73:	a1 c4 54 00 00       	mov    0x54c4,%eax
      78:	c7 44 24 04 63 3e 00 	movl   $0x3e63,0x4(%esp)
      7f:	00 
  ...
  for(i = 0; i < sizeof(uninit); i++){
    if(uninit[i] != '\0'){
      printf(stdout, "bss test failed\n");
      8a:	a1 c4 54 00 00       	mov    0x54c4,%eax
      8f:	c7 44 24 04 52 3e 00 	movl   $0x3e52,0x4(%esp)
      96:	00 
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
      b6:	a1 c4 54 00 00       	mov    0x54c4,%eax
      bb:	c7 44 24 04 70 3e 00 	movl   $0x3e70,0x4(%esp)
      c2:	00 
  ...
  fd = open("echo", 0);
      ...
      d2:	00 
      d3:	c7 04 24 7b 3e 00 00 	movl   $0x3e7b,(%esp)
  ...
  fd = open("doesnotexist", 0);
      ...
      f2:	00 
      f3:	c7 04 24 93 3e 00 00 	movl   $0x3e93,(%esp)
  ...
  printf(stdout, "open test ok\n");
     103:	a1 c4 54 00 00       	mov    0x54c4,%eax
     108:	c7 44 24 04 be 3e 00 	movl   $0x3ebe,0x4(%esp)
     10f:	00 
  ...
  if(fd < 0){
    printf(stdout, "open echo failed!\n");
     11a:	a1 c4 54 00 00       	mov    0x54c4,%eax
     11f:	c7 44 24 04 80 3e 00 	movl   $0x3e80,0x4(%esp)
     126:	00 
  ...
  if(fd >= 0){
    printf(stdout, "open doesnotexist succeeded!\n");
     134:	a1 c4 54 00 00       	mov    0x54c4,%eax
     139:	c7 44 24 04 a0 3e 00 	movl   $0x3ea0,0x4(%esp)
     140:	00 
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
     15b:	c7 44 24 04 cc 3e 00 	movl   $0x3ecc,0x4(%esp)
     162:	00 
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    name[5] = '\0';
    printf(1, "writing %s\n", name);
     19c:	c7 44 24 04 d9 3e 00 	movl   $0x3ed9,0x4(%esp)
     1a3:	00 
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    while(1){
     ...
     239:	00 
     23a:	c7 44 24 04 a0 7c 00 	movl   $0x7ca0,0x4(%esp)
     241:	00 
    ...
    printf(1, "wrote %d bytes\n", total);
     ...
     255:	c7 44 24 04 f5 3e 00 	movl   $0x3ef5,0x4(%esp)
     25c:	00 
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    if(fd < 0){
     ...
     284:	c7 44 24 04 e5 3e 00 	movl   $0x3ee5,0x4(%esp)
     28b:	00 
  ...
  printf(1, "fsfull test finished\n");
     335:	c7 44 24 04 05 3f 00 	movl   $0x3f05,0x4(%esp)
     33c:	00 
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
     36d:	c7 44 24 04 1b 3f 00 	movl   $0x3f1b,0x4(%esp)
     374:	00 
     375:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     37c:	e8 af 36 00 00       	call   3a30 <printf>

  unlink("bigwrite");
     381:	c7 04 24 2a 3f 00 00 	movl   $0x3f2a,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     397:	00 
     398:	c7 04 24 2a 3f 00 00 	movl   $0x3f2a,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    for(i = 0; i < 2; i++){
     ...
     3b2:	c7 44 24 04 a0 7c 00 	movl   $0x7ca0,0x4(%esp)
     3b9:	00 
    ...
    for(i = 0; i < 2; i++){
     ...
     3ca:	c7 44 24 04 a0 7c 00 	movl   $0x7ca0,0x4(%esp)
     3d1:	00 
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    unlink("bigwrite");
     3ec:	c7 04 24 2a 3f 00 00 	movl   $0x3f2a,(%esp)
  ...
  printf(1, "bigwrite ok\n");
     400:	c7 44 24 04 5d 3f 00 	movl   $0x3f5d,0x4(%esp)
     407:	00 
    ...
    for(i = 0; i < 2; i++){
     ...
     423:	c7 44 24 04 4b 3f 00 	movl   $0x3f4b,0x4(%esp)
     42a:	00 
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    if(fd < 0){
      printf(1, "cannot create bigwrite\n");
     43c:	c7 44 24 04 33 3f 00 	movl   $0x3f33,0x4(%esp)
     443:	00 
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     46c:	a1 c4 54 00 00       	mov    0x54c4,%eax
     471:	c7 44 24 04 6c 4d 00 	movl   $0x4d6c,0x4(%esp)
     478:	00 
     479:	89 04 24             	mov    %eax,(%esp)
     47c:	e8 af 35 00 00       	call   3a30 <printf>

  name[0] = 'a';
     481:	c6 05 a0 9c 00 00 61 	movb   $0x61,0x9ca0
  name[2] = '\0';
     488:	c6 05 a2 9c 00 00 00 	movb   $0x0,0x9ca2
     48f:	90                   	nop
  for(i = 0; i < 52; i++){
    name[1] = '0' + i;
     490:	88 1d a1 9c 00 00    	mov    %bl,0x9ca1
  ...
  for(i = 0; i < 52; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     4a0:	00 
     4a1:	c7 04 24 a0 9c 00 00 	movl   $0x9ca0,(%esp)
  ...
  name[0] = 'a';
     4ba:	c6 05 a0 9c 00 00 61 	movb   $0x61,0x9ca0
  name[2] = '\0';
     4c1:	bb 30 00 00 00       	mov    $0x30,%ebx
     4c6:	c6 05 a2 9c 00 00 00 	movb   $0x0,0x9ca2
     4cd:	8d 76 00             	lea    0x0(%esi),%esi
  for(i = 0; i < 52; i++){
    name[1] = '0' + i;
     4d0:	88 1d a1 9c 00 00    	mov    %bl,0x9ca1
    unlink(name);
     4d6:	83 c3 01             	add    $0x1,%ebx
     4d9:	c7 04 24 a0 9c 00 00 	movl   $0x9ca0,(%esp)
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     4ea:	a1 c4 54 00 00       	mov    0x54c4,%eax
     4ef:	c7 44 24 04 94 4d 00 	movl   $0x4d94,0x4(%esp)
     4f6:	00 
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     516:	a1 c4 54 00 00       	mov    0x54c4,%eax
     51b:	c7 44 24 04 6a 3f 00 	movl   $0x3f6a,0x4(%esp)
     522:	00 
     523:	89 04 24             	mov    %eax,(%esp)
     526:	e8 05 35 00 00       	call   3a30 <printf>
  if(exec("echo", echoargv) < 0){
     52b:	c7 44 24 04 b0 54 00 	movl   $0x54b0,0x4(%esp)
     532:	00 
     533:	c7 04 24 7b 3e 00 00 	movl   $0x3e7b,(%esp)
...
exectest(void)
{
  ...
  if(exec("echo", echoargv) < 0){
    printf(stdout, "exec echo failed\n");
     545:	a1 c4 54 00 00       	mov    0x54c4,%eax
     54a:	c7 44 24 04 75 3f 00 	movl   $0x3f75,0x4(%esp)
     551:	00 
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
     566:	c7 04 24 87 3f 00 00 	movl   $0x3f87,(%esp)
  ...
  fd = open("bigarg-ok", 0);
     ...
     592:	00 
     593:	c7 04 24 87 3f 00 00 	movl   $0x3f87,(%esp)
  ...
  unlink("bigarg-ok");
     5af:	c7 04 24 87 3f 00 00 	movl   $0x3f87,(%esp)
  ...
  if(pid == 0){
    ...
    for(i = 0; i < MAXARG-1; i++)
     ...
     5c0:	c7 04 85 e0 54 00 00 	movl   $0x4dbc,0x54e0(,%eax,4)
     5c7:	bc 4d 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    printf(stdout, "bigarg test\n");
     5d3:	a1 c4 54 00 00       	mov    0x54c4,%eax
  if(pid == 0){
    static char *args[MAXARG];
    int i;
    for(i = 0; i < MAXARG-1; i++)
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
     5d8:	c7 05 5c 55 00 00 00 	movl   $0x0,0x555c
     5df:	00 00 00 
    printf(stdout, "bigarg test\n");
     5e2:	c7 44 24 04 91 3f 00 	movl   $0x3f91,0x4(%esp)
     5e9:	00 
    ...
    exec("echo", args);
     ...
     5f9:	00 
     5fa:	c7 04 24 7b 3e 00 00 	movl   $0x3e7b,(%esp)
     601:	e8 1a 33 00 00       	call   3920 <exec>
    printf(stdout, "bigarg test ok\n");
     606:	a1 c4 54 00 00       	mov    0x54c4,%eax
     60b:	c7 44 24 04 9e 3f 00 	movl   $0x3f9e,0x4(%esp)
     612:	00 
    ...
    fd = open("bigarg-ok", O_CREATE);
     ...
     622:	00 
     623:	c7 04 24 87 3f 00 00 	movl   $0x3f87,(%esp)
  ...
  if(fd < 0){
    printf(stdout, "bigarg test failed!\n");
     63c:	a1 c4 54 00 00       	mov    0x54c4,%eax
     641:	c7 44 24 04 c7 3f 00 	movl   $0x3fc7,0x4(%esp)
     648:	00 
    ...
    printf(stdout, "bigargtest: fork failed\n");
     656:	a1 c4 54 00 00       	mov    0x54c4,%eax
     65b:	c7 44 24 04 ae 3f 00 	movl   $0x3fae,0x4(%esp)
     662:	00 
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
     679:	c7 44 24 04 dc 3f 00 	movl   $0x3fdc,0x4(%esp)
     680:	00 
     ...
     690:	74 6a                	je     6fc <forktest+0x8c>
{
  ...
  printf(1, "fork test OK\n");
     6ca:	c7 44 24 04 0e 40 00 	movl   $0x400e,0x4(%esp)
     6d1:	00 
  ...
  if(n == 1000){
    printf(1, "fork claimed to work 1000 times!\n");
     6e8:	c7 44 24 04 9c 4e 00 	movl   $0x4e9c,0x4(%esp)
     6ef:	00 
  ...
  for(; n > 0; n--){
    if(wait() < 0){
      printf(1, "wait stopped early\n");
     701:	c7 44 24 04 e7 3f 00 	movl   $0x3fe7,0x4(%esp)
     708:	00 
  ...
  if(wait() != -1){
    printf(1, "wait got too many\n");
     71a:	c7 44 24 04 fb 3f 00 	movl   $0x3ffb,0x4(%esp)
     721:	00 
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
     749:	c7 44 24 04 1c 40 00 	movl   $0x401c,0x4(%esp)
     750:	00 
  ...
  for(i = 0; i < N; i++){
    ...
    if(i > 0 && (i % 2 ) == 0){
     ...
     7e0:	c7 44 24 04 2f 40 00 	movl   $0x402f,0x4(%esp)
     7e7:	00 
  ...
  printf(1, "createdelete ok\n");
     8db:	c7 44 24 04 3e 40 00 	movl   $0x403e,0x4(%esp)
     8e2:	00 
  ...
  for(i = 0; i < N; i++){
    ...
    if(fd < 0){
      printf(1, "create failed\n");
     8f7:	c7 44 24 04 c3 40 00 	movl   $0x40c3,0x4(%esp)
     8fe:	00 
    ...
    if((i == 0 || i >= N/2) && fd < 0){
     ...
     92c:	c7 44 24 04 e4 4e 00 	movl   $0x4ee4,0x4(%esp)
     933:	00 
    ...
    if((i == 0 || i >= N/2) && fd < 0){
     ...
     949:	c7 44 24 04 c0 4e 00 	movl   $0x4ec0,0x4(%esp)
     950:	00 
  ...
  for(i = 0; i < N; i++){
    ...
    if((i == 0 || i >= N/2) && fd < 0){
     ...
     966:	c7 44 24 04 c0 4e 00 	movl   $0x4ec0,0x4(%esp)
     96d:	00 
  ...
  if(pid < 0){
    printf(1, "fork failed\n");
     97f:	c7 44 24 04 ba 3f 00 	movl   $0x3fba,0x4(%esp)
     986:	00 
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     9cd:	7d e1                	jge    9b0 <exitwait+0x10>
      printf(1, "fork failed\n");
     9cf:	c7 44 24 04 ba 3f 00 	movl   $0x3fba,0x4(%esp)
     9d6:	00 
  ...
  printf(1, "exitwait ok\n");
    ...
    if(pid){
     ...
     9f0:	c7 44 24 04 4f 40 00 	movl   $0x404f,0x4(%esp)
     9f7:	00 
  ...
  printf(1, "exitwait ok\n");
     a10:	c7 44 24 04 5f 40 00 	movl   $0x405f,0x4(%esp)
     a17:	00 
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
     a3a:	a1 c4 54 00 00       	mov    0x54c4,%eax
     a3f:	c7 44 24 04 6c 40 00 	movl   $0x406c,0x4(%esp)
     a46:	00 
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     a84:	c7 04 24 7b 40 00 00 	movl   $0x407b,(%esp)
  ...
  printf(stdout, "validate ok\n");
     aa3:	a1 c4 54 00 00       	mov    0x54c4,%eax
     aa8:	c7 44 24 04 9f 40 00 	movl   $0x409f,0x4(%esp)
     aaf:	00 
    ...
    if(link("nosuchfile", (char*)p) != -1){
      printf(stdout, "link should not succeed\n");
     abf:	a1 c4 54 00 00       	mov    0x54c4,%eax
     ac4:	c7 44 24 04 86 40 00 	movl   $0x4086,0x4(%esp)
     acb:	00 
...
bigdir(void)
{
  ...
  for(i = 0; i < 500; i++){
    ...
    if(link("bd", name) != 0){
     ...
     b5a:	c7 04 24 b9 40 00 00 	movl   $0x40b9,(%esp)
  ...
  unlink("bd");
     b75:	c7 04 24 b9 40 00 00 	movl   $0x40b9,(%esp)
  ...
  printf(1, "bigdir ok\n");
     bbd:	c7 44 24 04 fb 40 00 	movl   $0x40fb,0x4(%esp)
     bc4:	00 
    ...
    if(link("bd", name) != 0){
      printf(1, "bigdir link failed\n");
     bd8:	c7 44 24 04 d2 40 00 	movl   $0x40d2,0x4(%esp)
     bdf:	00 
    ...
    if(unlink(name) != 0){
      printf(1, "bigdir unlink failed");
     bf1:	c7 44 24 04 e6 40 00 	movl   $0x40e6,0x4(%esp)
     bf8:	00 
  ...
  if(fd < 0){
    printf(1, "bigdir create failed\n");
     c0a:	c7 44 24 04 bc 40 00 	movl   $0x40bc,0x4(%esp)
     c11:	00 
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
     c39:	c7 44 24 04 06 41 00 	movl   $0x4106,0x4(%esp)
     c40:	00 
     c41:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c48:	e8 e3 2d 00 00       	call   3a30 <printf>

  unlink("x");
     c4d:	c7 04 24 fe 49 00 00 	movl   $0x49fe,(%esp)
  ...
  for(i = 0; i < 100; i++){
    ...
    if((x % 3) == 0){
     ...
     c83:	74 7b                	je     d00 <linkunlink+0xd0>
      ...
      unlink("x");
     c85:	c7 04 24 fe 49 00 00 	movl   $0x49fe,(%esp)
  ...
  for(i = 0; i < 100; i++){
    ...
    if((x % 3) == 0){
      close(open("x", O_RDWR | O_CREATE));
     cbf:	c7 04 24 fe 49 00 00 	movl   $0x49fe,(%esp)
  ...
  printf(1, "linkunlink ok\n");
     ce4:	c7 44 24 04 1b 41 00 	movl   $0x411b,0x4(%esp)
     ceb:	00 
  ...
  for(i = 0; i < 100; i++){
    ...
    if((x % 3) == 0){
      ...
      link("cat", "x");
     d00:	c7 44 24 04 fe 49 00 	movl   $0x49fe,0x4(%esp)
     d07:	00 
     d08:	c7 04 24 17 41 00 00 	movl   $0x4117,(%esp)
  ...
  if(pid < 0){
    printf(1, "fork failed\n");
     d19:	c7 44 24 04 ba 3f 00 	movl   $0x3fba,0x4(%esp)
     d20:	00 
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
     d4b:	a1 c4 54 00 00       	mov    0x54c4,%eax
     d50:	c7 44 24 04 2a 41 00 	movl   $0x412a,0x4(%esp)
     d57:	00 
...
#define BIG (100*1024*1024)
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
     faf:	a1 c4 54 00 00       	mov    0x54c4,%eax
     fb4:	c7 44 24 04 e1 41 00 	movl   $0x41e1,0x4(%esp)
     fbb:	00 
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    if((pids[i] = fork()) == 0){
     ...
     ff1:	00 
     ff2:	c7 44 24 04 fe 49 00 	movl   $0x49fe,0x4(%esp)
     ff9:	00 
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    101a:	a1 c4 54 00 00       	mov    0x54c4,%eax
    101f:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
    1023:	89 74 24 08          	mov    %esi,0x8(%esp)
    1027:	c7 44 24 04 35 41 00 	movl   $0x4135,0x4(%esp)
    102e:	00 
  ...
  if(c == (char*)0xffffffff){
    printf(stdout, "failed sbrk leaked memory\n");
    103c:	a1 c4 54 00 00       	mov    0x54c4,%eax
    1041:	c7 44 24 04 c6 41 00 	movl   $0x41c6,0x4(%esp)
    1048:	00 
  ...
  if(pipe(fds) != 0){
    printf(1, "pipe() failed\n");
    1056:	c7 44 24 04 b7 41 00 	movl   $0x41b7,0x4(%esp)
    105d:	00 
    ...
    1076:	c7 44 24 04 9e 41 00 	movl   $0x419e,0x4(%esp)
    107d:	00 
    107e:	89 44 24 0c          	mov    %eax,0xc(%esp)
    1082:	a1 c4 54 00 00       	mov    0x54c4,%eax
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    if(pid < 0){
      printf(stdout, "fork failed\n");
    109c:	a1 c4 54 00 00       	mov    0x54c4,%eax
    10a1:	c7 44 24 04 ba 3f 00 	movl   $0x3fba,0x4(%esp)
    10a8:	00 
  ...
  if(c != a){
    ...
    10ba:	a1 c4 54 00 00       	mov    0x54c4,%eax
    10bf:	89 74 24 08          	mov    %esi,0x8(%esp)
    10c3:	c7 44 24 04 d4 4f 00 	movl   $0x4fd4,0x4(%esp)
    10ca:	00 
  ...
  if(*lastaddr == 99){
    // should be zero
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    10d8:	a1 c4 54 00 00       	mov    0x54c4,%eax
    10dd:	c7 44 24 04 a4 4f 00 	movl   $0x4fa4,0x4(%esp)
    10e4:	00 
  ...
  if(c != a || sbrk(0) != a + 4096){
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    10f2:	a1 c4 54 00 00       	mov    0x54c4,%eax
    10f7:	89 74 24 0c          	mov    %esi,0xc(%esp)
    10fb:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    10ff:	c7 44 24 04 7c 4f 00 	movl   $0x4f7c,0x4(%esp)
    1106:	00 
  ...
  if(c != a - 4096){
    ...
    1118:	a1 c4 54 00 00       	mov    0x54c4,%eax
    111d:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    1121:	c7 44 24 04 44 4f 00 	movl   $0x4f44,0x4(%esp)
    1128:	00 
  ...
  if(c == (char*)0xffffffff){
    printf(stdout, "sbrk could not deallocate\n");
    1136:	a1 c4 54 00 00       	mov    0x54c4,%eax
    113b:	c7 44 24 04 83 41 00 	movl   $0x4183,0x4(%esp)
    1142:	00 
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    printf(stdout, "sbrk test failed to grow big address space; enough phys mem?\n");
    1150:	a1 c4 54 00 00       	mov    0x54c4,%eax
    1155:	c7 44 24 04 04 4f 00 	movl   $0x4f04,0x4(%esp)
    115c:	00 
  ...
  if(c != a + 1){
    printf(stdout, "sbrk test failed post-fork\n");
    116a:	a1 c4 54 00 00       	mov    0x54c4,%eax
    116f:	c7 44 24 04 67 41 00 	movl   $0x4167,0x4(%esp)
    1176:	00 
  ...
  if(pid < 0){
    printf(stdout, "sbrk test fork failed\n");
    1184:	a1 c4 54 00 00       	mov    0x54c4,%eax
    1189:	c7 44 24 04 50 41 00 	movl   $0x4150,0x4(%esp)
    1190:	00 
...
linktest(void)
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    11f8:	00 
    11f9:	c7 44 24 04 14 42 00 	movl   $0x4214,0x4(%esp)
    1200:	00 
  ...
  if(link("lf1", "lf2") < 0){
    121a:	c7 44 24 04 fd 41 00 	movl   $0x41fd,0x4(%esp)
    1221:	00 
    1222:	c7 04 24 f9 41 00 00 	movl   $0x41f9,(%esp)
  ...
  unlink("lf1");
    1236:	c7 04 24 f9 41 00 00 	movl   $0x41f9,(%esp)
    123d:	e8 f6 26 00 00       	call   3938 <unlink>

  if(open("lf1", 0) >= 0){
    1242:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    1249:	00 
    124a:	c7 04 24 f9 41 00 00 	movl   $0x41f9,(%esp)
  ...
  fd = open("lf2", 0);
    ...
    1265:	00 
    1266:	c7 04 24 fd 41 00 00 	movl   $0x41fd,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1283:	00 
    1284:	c7 44 24 04 a0 7c 00 	movl   $0x7ca0,0x4(%esp)
    128b:	00 
  ...
  if(link("lf2", "lf2") >= 0){
    12a5:	c7 44 24 04 fd 41 00 	movl   $0x41fd,0x4(%esp)
    12ac:	00 
    12ad:	c7 04 24 fd 41 00 00 	movl   $0x41fd,(%esp)
  ...
  unlink("lf2");
    12c1:	c7 04 24 fd 41 00 00 	movl   $0x41fd,(%esp)
    12c8:	e8 6b 26 00 00       	call   3938 <unlink>
  if(link("lf2", "lf1") >= 0){
    12cd:	c7 44 24 04 f9 41 00 	movl   $0x41f9,0x4(%esp)
    12d4:	00 
    12d5:	c7 04 24 fd 41 00 00 	movl   $0x41fd,(%esp)
  ...
  if(link(".", "lf1") >= 0){
    12e5:	c7 44 24 04 f9 41 00 	movl   $0x41f9,0x4(%esp)
    12ec:	00 
    12ed:	c7 04 24 1b 49 00 00 	movl   $0x491b,(%esp)
  ...
  printf(1, "linktest ok\n");
    12fd:	c7 44 24 04 9d 42 00 	movl   $0x429d,0x4(%esp)
    1304:	00 
  ...
  if(fd < 0){
    printf(1, "create lf1 failed\n");
    1317:	c7 44 24 04 01 42 00 	movl   $0x4201,0x4(%esp)
    131e:	00 
  ...
  if(link(".", "lf1") >= 0){
    printf(1, "link . lf1 succeeded! oops\n");
    1330:	c7 44 24 04 81 42 00 	movl   $0x4281,0x4(%esp)
    1337:	00 
  ...
  if(link("lf2", "lf1") >= 0){
    printf(1, "link non-existant succeeded! oops\n");
    1349:	c7 44 24 04 20 50 00 	movl   $0x5020,0x4(%esp)
    1350:	00 
  ...
  if(link("lf2", "lf2") >= 0){
    printf(1, "link lf2 lf2 succeeded! oops\n");
    1362:	c7 44 24 04 63 42 00 	movl   $0x4263,0x4(%esp)
    1369:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    printf(1, "read lf2 failed\n");
    137b:	c7 44 24 04 52 42 00 	movl   $0x4252,0x4(%esp)
    1382:	00 
  ...
  if(fd < 0){
    printf(1, "open lf2 failed\n");
    1394:	c7 44 24 04 41 42 00 	movl   $0x4241,0x4(%esp)
    139b:	00 
  ...
  if(open("lf1", 0) >= 0){
    printf(1, "unlinked lf1 but it is still there!\n");
    13ad:	c7 44 24 04 f8 4f 00 	movl   $0x4ff8,0x4(%esp)
    13b4:	00 
  ...
  if(link("lf1", "lf2") < 0){
    printf(1, "link lf1 lf2 failed\n");
    13c6:	c7 44 24 04 2c 42 00 	movl   $0x422c,0x4(%esp)
    13cd:	00 
  ...
  if(write(fd, "hello", 5) != 5){
    printf(1, "write lf1 failed\n");
    13df:	c7 44 24 04 1a 42 00 	movl   $0x421a,0x4(%esp)
    13e6:	00 
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1408:	c7 44 24 04 aa 42 00 	movl   $0x42aa,0x4(%esp)
    140f:	00 
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1423:	00 
    1424:	c7 04 24 bb 42 00 00 	movl   $0x42bb,(%esp)
...
unlinkread(void)
{
  ...
  write(fd, "hello", 5);
    ...
    1441:	00 
    1442:	c7 44 24 04 14 42 00 	movl   $0x4214,0x4(%esp)
    1449:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    1461:	00 
    1462:	c7 04 24 bb 42 00 00 	movl   $0x42bb,(%esp)
  ...
  if(unlink("unlinkread") != 0){
    1478:	c7 04 24 bb 42 00 00 	movl   $0x42bb,(%esp)
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1493:	00 
    1494:	c7 04 24 bb 42 00 00 	movl   $0x42bb,(%esp)
    149b:	e8 88 24 00 00       	call   3928 <open>
  write(fd1, "yyy", 3);
    14a0:	c7 44 24 08 03 00 00 	movl   $0x3,0x8(%esp)
    14a7:	00 
    14a8:	c7 44 24 04 12 43 00 	movl   $0x4312,0x4(%esp)
    14af:	00 
  if(unlink("unlinkread") != 0){
    printf(1, "unlink unlinkread failed\n");
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    14c9:	00 
    14ca:	c7 44 24 04 a0 7c 00 	movl   $0x7ca0,0x4(%esp)
    14d1:	00 
  ...
  if(buf[0] != 'h'){
    14e3:	80 3d a0 7c 00 00 68 	cmpb   $0x68,0x7ca0
  ...
  if(write(fd, buf, 10) != 10){
    ...
    14f3:	00 
    14f4:	c7 44 24 04 a0 7c 00 	movl   $0x7ca0,0x4(%esp)
    14fb:	00 
  ...
  unlink("unlinkread");
    1511:	c7 04 24 bb 42 00 00 	movl   $0x42bb,(%esp)
    1518:	e8 1b 24 00 00       	call   3938 <unlink>
  printf(1, "unlinkread ok\n");
    151d:	c7 44 24 04 5d 43 00 	movl   $0x435d,0x4(%esp)
    1524:	00 
  ...
  if(fd < 0){
    printf(1, "create unlinkread failed\n");
    1538:	c7 44 24 04 c6 42 00 	movl   $0x42c6,0x4(%esp)
    153f:	00 
  ...
  if(write(fd, buf, 10) != 10){
    printf(1, "unlinkread write failed\n");
    1551:	c7 44 24 04 44 43 00 	movl   $0x4344,0x4(%esp)
    1558:	00 
  ...
  if(buf[0] != 'h'){
    printf(1, "unlinkread wrong data\n");
    156a:	c7 44 24 04 2d 43 00 	movl   $0x432d,0x4(%esp)
    1571:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    printf(1, "unlinkread read failed");
    1583:	c7 44 24 04 16 43 00 	movl   $0x4316,0x4(%esp)
    158a:	00 
  ...
  if(unlink("unlinkread") != 0){
    printf(1, "unlink unlinkread failed\n");
    159c:	c7 44 24 04 f8 42 00 	movl   $0x42f8,0x4(%esp)
    15a3:	00 
  ...
  if(fd < 0){
    printf(1, "open unlinkread failed\n");
    15b5:	c7 44 24 04 e0 42 00 	movl   $0x42e0,0x4(%esp)
    15bc:	00 
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
    15d9:	c7 44 24 04 6c 43 00 	movl   $0x436c,0x4(%esp)
    15e0:	00 
    ...
    15f2:	85 c0                	test   %eax,%eax
{
  ...
  if(pid3 == 0){
    ...
    1638:	00 
    1639:	c7 44 24 04 fe 49 00 	movl   $0x49fe,0x4(%esp)
    1640:	00 
    ...
    164e:	c7 44 24 04 76 43 00 	movl   $0x4376,0x4(%esp)
    1655:	00 
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    1684:	00 
    1685:	c7 44 24 04 a0 7c 00 	movl   $0x7ca0,0x4(%esp)
    168c:	00 
    ...
    169a:	c7 44 24 04 8a 43 00 	movl   $0x438a,0x4(%esp)
    16a1:	00 
  ...
  printf(1, "kill... ");
    16c1:	c7 44 24 04 9d 43 00 	movl   $0x439d,0x4(%esp)
    16c8:	00 
  ...
  printf(1, "wait... ");
    16ed:	c7 44 24 04 a6 43 00 	movl   $0x43a6,0x4(%esp)
    16f4:	00 
  ...
  printf(1, "preempt ok\n");
    1715:	c7 44 24 04 af 43 00 	movl   $0x43af,0x4(%esp)
    171c:	00 
...
pipe1(void)
{
  ...
  if(pid == 0){
    ...
    177b:	c7 44 24 04 a0 7c 00 	movl   $0x7ca0,0x4(%esp)
    1782:	00 
    ...
    1798:	38 9a a0 7c 00 00    	cmp    %bl,0x7ca0(%edx)
    ...
    while((n = read(fds[0], buf, cc)) > 0){
      for(i = 0; i < n; i++){
        if((buf[i] & 0xff) != (seq++ & 0xff)){
          printf(1, "pipe1 oops 2\n");
    17be:	c7 44 24 04 c9 43 00 	movl   $0x43c9,0x4(%esp)
    17c5:	00 
  ...
  if(pid == 0){
    ...
    17f3:	88 90 a0 7c 00 00    	mov    %dl,0x7ca0(%eax)
  pid = fork();
  seq = 0;
  if(pid == 0){
    close(fds[0]);
  ...
  if(pid == 0){
    ...
    1813:	00 
    1814:	c7 44 24 04 a0 7c 00 	movl   $0x7ca0,0x4(%esp)
    181b:	00 
  ...
  printf(1, "pipe1 ok\n");
    1854:	c7 44 24 04 ee 43 00 	movl   $0x43ee,0x4(%esp)
    185b:	00 
    ...
    1871:	c7 44 24 04 d7 43 00 	movl   $0x43d7,0x4(%esp)
    1878:	00 
    ...
    1885:	eb b0                	jmp    1837 <pipe1+0x107>
{
  ...
  if(pipe(fds) != 0){
    printf(1, "pipe() failed\n");
    1887:	c7 44 24 04 b7 41 00 	movl   $0x41b7,0x4(%esp)
    188e:	00 
    ...
    printf(1, "fork() failed\n");
    18a0:	c7 44 24 04 f8 43 00 	movl   $0x43f8,0x4(%esp)
    18a7:	00 
    ...
    for(n = 0; n < 5; n++){
      ...
      if(write(fds[1], buf, 1033) != 1033){
        printf(1, "pipe1 oops 1\n");
    18b9:	c7 44 24 04 bb 43 00 	movl   $0x43bb,0x4(%esp)
    18c0:	00 
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
    18e8:	a1 c4 54 00 00       	mov    0x54c4,%eax
    18ed:	c7 44 24 04 07 44 00 	movl   $0x4407,0x4(%esp)
    18f4:	00 
  ...
  fd = open("big", O_CREATE|O_RDWR);
    ...
    1904:	00 
    1905:	c7 04 24 81 44 00 00 	movl   $0x4481,(%esp)
    ...
    1911:	85 c0                	test   %eax,%eax
{
  ...
  for(i = 0; i < MAXFILE; i++){
    ((int*)buf)[0] = i;
    1920:	89 1d a0 7c 00 00    	mov    %ebx,0x7ca0
    if(write(fd, buf, 512) != 512){
    1926:	c7 44 24 08 00 02 00 	movl   $0x200,0x8(%esp)
    192d:	00 
    192e:	c7 44 24 04 a0 7c 00 	movl   $0x7ca0,0x4(%esp)
    1935:	00 
  ...
  fd = open("big", O_RDONLY);
    ...
    1963:	00 
    1964:	c7 04 24 81 44 00 00 	movl   $0x4481,(%esp)
  ...
  if(fd < 0){
    ...
    if(((int*)buf)[0] != n){
    198b:	a1 a0 7c 00 00       	mov    0x7ca0,%eax
  ...
  for(;;){
    ...
    19a2:	00 
    19a3:	c7 44 24 04 a0 7c 00 	movl   $0x7ca0,0x4(%esp)
    19aa:	00 
  ...
  if(unlink("big") < 0){
    19cb:	c7 04 24 81 44 00 00 	movl   $0x4481,(%esp)
  ...
  printf(stdout, "big files ok\n");
    19df:	a1 c4 54 00 00       	mov    0x54c4,%eax
    19e4:	c7 44 24 04 a8 44 00 	movl   $0x44a8,0x4(%esp)
    19eb:	00 
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
      printf(stdout, "error: write big file failed\n", i);
    19fb:	a1 c4 54 00 00       	mov    0x54c4,%eax
    1a00:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    1a04:	c7 44 24 04 31 44 00 	movl   $0x4431,0x4(%esp)
    1a0b:	00 
    ...
    1a1d:	a1 c4 54 00 00       	mov    0x54c4,%eax
    1a22:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    1a26:	c7 44 24 04 44 50 00 	movl   $0x5044,0x4(%esp)
    1a2d:	00 
    ...
    1a3f:	a1 c4 54 00 00       	mov    0x54c4,%eax
    1a44:	c7 44 24 04 85 44 00 	movl   $0x4485,0x4(%esp)
    1a4b:	00 
  ...
  for(;;){
    ...
    if(i == 0){
      if(n == MAXFILE - 1){
        printf(stdout, "read only %d blocks from big", n);
    1a59:	a1 c4 54 00 00       	mov    0x54c4,%eax
    1a5e:	c7 44 24 08 8b 00 00 	movl   $0x8b,0x8(%esp)
    1a65:	00 
    1a66:	c7 44 24 04 68 44 00 	movl   $0x4468,0x4(%esp)
    1a6d:	00 
  ...
  if(fd < 0){
    printf(stdout, "error: open big failed!\n");
    1a7b:	a1 c4 54 00 00       	mov    0x54c4,%eax
    1a80:	c7 44 24 04 4f 44 00 	movl   $0x444f,0x4(%esp)
    1a87:	00 
  ...
  if(fd < 0){
    printf(stdout, "error: creat big failed!\n");
    1a95:	a1 c4 54 00 00       	mov    0x54c4,%eax
    1a9a:	c7 44 24 04 17 44 00 	movl   $0x4417,0x4(%esp)
    1aa1:	00 
  ...
  if(unlink("big") < 0){
    printf(stdout, "unlink big failed\n");
    1aaf:	a1 c4 54 00 00       	mov    0x54c4,%eax
    1ab4:	c7 44 24 04 95 44 00 	movl   $0x4495,0x4(%esp)
    1abb:	00 
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
    1ad8:	a1 c4 54 00 00       	mov    0x54c4,%eax
    1add:	c7 44 24 04 b6 44 00 	movl   $0x44b6,0x4(%esp)
    1ae4:	00 
  ...
  fd = open("small", O_CREATE|O_RDWR);
    ...
    1af4:	00 
    1af5:	c7 04 24 c7 44 00 00 	movl   $0x44c7,(%esp)
    ...
    1b01:	85 c0                	test   %eax,%eax
{
  ...
  if(fd >= 0){
    ...
    1b0b:	a1 c4 54 00 00       	mov    0x54c4,%eax
    1b10:	31 db                	xor    %ebx,%ebx
    1b12:	c7 44 24 04 cd 44 00 	movl   $0x44cd,0x4(%esp)
    1b19:	00 
  ...
  for(i = 0; i < 100; i++){
    ...
    1b2f:	00 
    1b30:	c7 44 24 04 04 45 00 	movl   $0x4504,0x4(%esp)
    1b37:	00 
    ...
    1b50:	00 
    1b51:	c7 44 24 04 0f 45 00 	movl   $0x450f,0x4(%esp)
    1b58:	00 
  ...
  printf(stdout, "writes ok\n");
    1b72:	a1 c4 54 00 00       	mov    0x54c4,%eax
    1b77:	c7 44 24 04 1a 45 00 	movl   $0x451a,0x4(%esp)
    1b7e:	00 
  ...
  fd = open("small", O_RDONLY);
    ...
    1b96:	00 
    1b97:	c7 04 24 c7 44 00 00 	movl   $0x44c7,(%esp)
  ...
  if(fd >= 0){
    ...
    1bad:	a1 c4 54 00 00       	mov    0x54c4,%eax
    1bb2:	c7 44 24 04 25 45 00 	movl   $0x4525,0x4(%esp)
    1bb9:	00 
  ...
  i = read(fd, buf, 2000);
    ...
    1bc9:	00 
    1bca:	c7 44 24 04 a0 7c 00 	movl   $0x7ca0,0x4(%esp)
    1bd1:	00 
  ...
  if(i == 2000){
    ...
    1be5:	a1 c4 54 00 00       	mov    0x54c4,%eax
    1bea:	c7 44 24 04 59 45 00 	movl   $0x4559,0x4(%esp)
    1bf1:	00 
  ...
  if(unlink("small") < 0){
    1c02:	c7 04 24 c7 44 00 00 	movl   $0x44c7,(%esp)
  ...
  printf(stdout, "small file test ok\n");
    1c16:	a1 c4 54 00 00       	mov    0x54c4,%eax
    1c1b:	c7 44 24 04 81 45 00 	movl   $0x4581,0x4(%esp)
    1c22:	00 
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
      printf(stdout, "error: write aa %d new file failed\n", i);
    1c32:	a1 c4 54 00 00       	mov    0x54c4,%eax
    1c37:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    1c3b:	c7 44 24 04 64 50 00 	movl   $0x5064,0x4(%esp)
    1c42:	00 
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
      printf(stdout, "error: write bb %d new file failed\n", i);
    1c50:	a1 c4 54 00 00       	mov    0x54c4,%eax
    1c55:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    1c59:	c7 44 24 04 88 50 00 	movl   $0x5088,0x4(%esp)
    1c60:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
    1c6e:	a1 c4 54 00 00       	mov    0x54c4,%eax
    1c73:	c7 44 24 04 3e 45 00 	movl   $0x453e,0x4(%esp)
    1c7a:	00 
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
    1c88:	a1 c4 54 00 00       	mov    0x54c4,%eax
    1c8d:	c7 44 24 04 d3 42 00 	movl   $0x42d3,0x4(%esp)
    1c94:	00 
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
    1ca2:	a1 c4 54 00 00       	mov    0x54c4,%eax
    1ca7:	c7 44 24 04 6c 45 00 	movl   $0x456c,0x4(%esp)
    1cae:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
    1cbc:	a1 c4 54 00 00       	mov    0x54c4,%eax
    1cc1:	c7 44 24 04 e8 44 00 	movl   $0x44e8,0x4(%esp)
    1cc8:	00 
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    1ce6:	c7 44 24 04 95 45 00 	movl   $0x4595,0x4(%esp)
    1ced:	00 
    1cee:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cf5:	e8 36 1d 00 00       	call   3a30 <printf>

  if(mkdir("12345678901234") != 0){
    1cfa:	c7 04 24 d0 45 00 00 	movl   $0x45d0,(%esp)
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    1d0e:	c7 04 24 ac 50 00 00 	movl   $0x50ac,(%esp)
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    1d29:	00 
    1d2a:	c7 04 24 fc 50 00 00 	movl   $0x50fc,(%esp)
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    1d4d:	00 
    1d4e:	c7 04 24 6c 51 00 00 	movl   $0x516c,(%esp)
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    1d6a:	c7 04 24 c1 45 00 00 	movl   $0x45c1,(%esp)
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    1d7a:	c7 04 24 08 52 00 00 	movl   $0x5208,(%esp)
  ...
  printf(1, "fourteen ok\n");
    1d8a:	c7 44 24 04 df 45 00 	movl   $0x45df,0x4(%esp)
    1d91:	00 
  ...
  if(mkdir("12345678901234") != 0){
    printf(1, "mkdir 12345678901234 failed\n");
    1da0:	c7 44 24 04 a4 45 00 	movl   $0x45a4,0x4(%esp)
    1da7:	00 
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
    1db9:	c7 44 24 04 28 52 00 	movl   $0x5228,0x4(%esp)
    1dc0:	00 
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
    1dd2:	c7 44 24 04 d8 51 00 	movl   $0x51d8,0x4(%esp)
    1dd9:	00 
  ...
  if(fd < 0){
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
    1deb:	c7 44 24 04 9c 51 00 	movl   $0x519c,0x4(%esp)
    1df2:	00 
  ...
  if(fd < 0){
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
    1e04:	c7 44 24 04 2c 51 00 	movl   $0x512c,0x4(%esp)
    1e0b:	00 
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    1e1d:	c7 44 24 04 cc 50 00 	movl   $0x50cc,0x4(%esp)
    1e24:	00 
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    1e49:	c7 44 24 04 ec 45 00 	movl   $0x45ec,0x4(%esp)
    1e50:	00 
  ...
  for(i = 0; i < 50 + 1; i++){
    if(mkdir("irefd") != 0){
    1e60:	c7 04 24 fd 45 00 00 	movl   $0x45fd,(%esp)
    ...
    if(chdir("irefd") != 0){
    1e74:	c7 04 24 fd 45 00 00 	movl   $0x45fd,(%esp)
    ...
    mkdir("");
    1e88:	c7 04 24 2f 4d 00 00 	movl   $0x4d2f,(%esp)
    1e8f:	e8 bc 1a 00 00       	call   3950 <mkdir>
    link("README", "");
    1e94:	c7 44 24 04 2f 4d 00 	movl   $0x4d2f,0x4(%esp)
    1e9b:	00 
    1e9c:	c7 04 24 2b 46 00 00 	movl   $0x462b,(%esp)
    1ea3:	e8 a0 1a 00 00       	call   3948 <link>
    fd = open("", O_CREATE);
    1ea8:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1eaf:	00 
    1eb0:	c7 04 24 2f 4d 00 00 	movl   $0x4d2f,(%esp)
    ...
    1ecf:	00 
    1ed0:	c7 04 24 fd 49 00 00 	movl   $0x49fd,(%esp)
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    if(fd >= 0)
      close(fd);
    unlink("xx");
    1eeb:	c7 04 24 fd 49 00 00 	movl   $0x49fd,(%esp)
  ...
  chdir("/");
    1f00:	c7 04 24 32 46 00 00 	movl   $0x4632,(%esp)
    1f07:	e8 4c 1a 00 00       	call   3958 <chdir>
  printf(1, "empty file name OK\n");
    1f0c:	c7 44 24 04 34 46 00 	movl   $0x4634,0x4(%esp)
    1f13:	00 
  ...
  for(i = 0; i < 50 + 1; i++){
    if(mkdir("irefd") != 0){
      printf(1, "mkdir irefd failed\n");
    1f26:	c7 44 24 04 03 46 00 	movl   $0x4603,0x4(%esp)
    1f2d:	00 
    ...
    if(chdir("irefd") != 0){
      printf(1, "chdir irefd failed\n");
    1f3f:	c7 44 24 04 17 46 00 	movl   $0x4617,0x4(%esp)
    1f46:	00 
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    1f67:	c7 44 24 04 48 46 00 	movl   $0x4648,0x4(%esp)
    1f6e:	00 
  ...
  fd = open("dirfile", O_CREATE);
    ...
    1f82:	00 
    1f83:	c7 04 24 55 46 00 00 	movl   $0x4655,(%esp)
  ...
  if(chdir("dirfile") == 0){
    1f9f:	c7 04 24 55 46 00 00 	movl   $0x4655,(%esp)
  ...
  fd = open("dirfile/xx", 0);
    ...
    1fba:	00 
    1fbb:	c7 04 24 8e 46 00 00 	movl   $0x468e,(%esp)
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    1fd6:	00 
    1fd7:	c7 04 24 8e 46 00 00 	movl   $0x468e,(%esp)
  ...
  if(mkdir("dirfile/xx") == 0){
    1feb:	c7 04 24 8e 46 00 00 	movl   $0x468e,(%esp)
  ...
  if(unlink("dirfile/xx") == 0){
    1fff:	c7 04 24 8e 46 00 00 	movl   $0x468e,(%esp)
  ...
  if(link("README", "dirfile/xx") == 0){
    2013:	c7 44 24 04 8e 46 00 	movl   $0x468e,0x4(%esp)
    201a:	00 
    201b:	c7 04 24 2b 46 00 00 	movl   $0x462b,(%esp)
  ...
  if(unlink("dirfile") != 0){
    202f:	c7 04 24 55 46 00 00 	movl   $0x4655,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    204a:	00 
    204b:	c7 04 24 1b 49 00 00 	movl   $0x491b,(%esp)
  ...
  fd = open(".", 0);
    ...
    2066:	00 
    2067:	c7 04 24 1b 49 00 00 	movl   $0x491b,(%esp)
    206e:	e8 b5 18 00 00       	call   3928 <open>
  if(write(fd, "x", 1) > 0){
    2073:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    207a:	00 
    207b:	c7 44 24 04 fe 49 00 	movl   $0x49fe,0x4(%esp)
    2082:	00 
  fd = open(".", O_RDWR);
  if(fd >= 0){
    printf(1, "open . for writing succeeded!\n");
  ...
  printf(1, "dir vs file OK\n");
    2099:	c7 44 24 04 1e 47 00 	movl   $0x471e,0x4(%esp)
    20a0:	00 
  ...
  if(fd >= 0){
    printf(1, "create dirfile/xx succeeded!\n");
    20b3:	c7 44 24 04 99 46 00 	movl   $0x4699,0x4(%esp)
    20ba:	00 
  ...
  if(chdir("dirfile") == 0){
    printf(1, "chdir dirfile succeeded!\n");
    20cc:	c7 44 24 04 74 46 00 	movl   $0x4674,0x4(%esp)
    20d3:	00 
  ...
  if(fd < 0){
    printf(1, "create dirfile failed\n");
    20e5:	c7 44 24 04 5d 46 00 	movl   $0x465d,0x4(%esp)
    20ec:	00 
  ...
  if(write(fd, "x", 1) > 0){
    printf(1, "write . succeeded!\n");
    20fe:	c7 44 24 04 0a 47 00 	movl   $0x470a,0x4(%esp)
    2105:	00 
  ...
  if(fd >= 0){
    printf(1, "open . for writing succeeded!\n");
    2117:	c7 44 24 04 7c 52 00 	movl   $0x527c,0x4(%esp)
    211e:	00 
  ...
  if(unlink("dirfile") != 0){
    printf(1, "unlink dirfile failed!\n");
    2130:	c7 44 24 04 f2 46 00 	movl   $0x46f2,0x4(%esp)
    2137:	00 
  ...
  if(link("README", "dirfile/xx") == 0){
    printf(1, "link to dirfile/xx succeeded!\n");
    2149:	c7 44 24 04 5c 52 00 	movl   $0x525c,0x4(%esp)
    2150:	00 
  ...
  if(unlink("dirfile/xx") == 0){
    printf(1, "unlink dirfile/xx succeeded!\n");
    2162:	c7 44 24 04 d4 46 00 	movl   $0x46d4,0x4(%esp)
    2169:	00 
  ...
  if(mkdir("dirfile/xx") == 0){
    printf(1, "mkdir dirfile/xx succeeded!\n");
    217b:	c7 44 24 04 b7 46 00 	movl   $0x46b7,0x4(%esp)
    2182:	00 
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    21a6:	c7 44 24 04 2e 47 00 	movl   $0x472e,0x4(%esp)
    21ad:	00 
    21ae:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    21b5:	e8 76 18 00 00       	call   3a30 <printf>
  if(mkdir("dots") != 0){
    21ba:	c7 04 24 3a 47 00 00 	movl   $0x473a,(%esp)
  ...
  if(chdir("dots") != 0){
    21ce:	c7 04 24 3a 47 00 00 	movl   $0x473a,(%esp)
  ...
  if(unlink(".") == 0){
    21e2:	c7 04 24 1b 49 00 00 	movl   $0x491b,(%esp)
  ...
  if(unlink("..") == 0){
    21f6:	c7 04 24 1a 49 00 00 	movl   $0x491a,(%esp)
  ...
  if(chdir("/") != 0){
    220a:	c7 04 24 32 46 00 00 	movl   $0x4632,(%esp)
  ...
  if(unlink("dots/.") == 0){
    221e:	c7 04 24 92 47 00 00 	movl   $0x4792,(%esp)
  ...
  if(unlink("dots/..") == 0){
    2232:	c7 04 24 b0 47 00 00 	movl   $0x47b0,(%esp)
  ...
  if(unlink("dots") != 0){
    2242:	c7 04 24 3a 47 00 00 	movl   $0x473a,(%esp)
  ...
  printf(1, "rmdot ok\n");
    2252:	c7 44 24 04 e5 47 00 	movl   $0x47e5,0x4(%esp)
    2259:	00 
...
rmdot(void)
{
  ...
  if(mkdir("dots") != 0){
    printf(1, "mkdir dots failed\n");
    2268:	c7 44 24 04 3f 47 00 	movl   $0x473f,0x4(%esp)
    226f:	00 
  ...
  if(unlink("dots") != 0){
    printf(1, "unlink dots failed!\n");
    2281:	c7 44 24 04 d0 47 00 	movl   $0x47d0,0x4(%esp)
    2288:	00 
  ...
  if(unlink("dots/..") == 0){
    printf(1, "unlink dots/.. worked!\n");
    229a:	c7 44 24 04 b8 47 00 	movl   $0x47b8,0x4(%esp)
    22a1:	00 
  ...
  if(unlink("dots/.") == 0){
    printf(1, "unlink dots/. worked!\n");
    22b3:	c7 44 24 04 99 47 00 	movl   $0x4799,0x4(%esp)
    22ba:	00 
  ...
  if(chdir("/") != 0){
    printf(1, "chdir / failed\n");
    22cc:	c7 44 24 04 82 47 00 	movl   $0x4782,0x4(%esp)
    22d3:	00 
  ...
  if(unlink("..") == 0){
    printf(1, "rm .. worked!\n");
    22e5:	c7 44 24 04 73 47 00 	movl   $0x4773,0x4(%esp)
    22ec:	00 
  ...
  if(unlink(".") == 0){
    printf(1, "rm . worked!\n");
    22fe:	c7 44 24 04 65 47 00 	movl   $0x4765,0x4(%esp)
    2305:	00 
  ...
  if(chdir("dots") != 0){
    printf(1, "chdir dots failed\n");
    2317:	c7 44 24 04 52 47 00 	movl   $0x4752,0x4(%esp)
    231e:	00 
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    2337:	c7 44 24 04 ef 47 00 	movl   $0x47ef,0x4(%esp)
    233e:	00 
    233f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2346:	e8 e5 16 00 00       	call   3a30 <printf>

  unlink("ff");
    234b:	c7 04 24 78 48 00 00 	movl   $0x4878,(%esp)
    2352:	e8 e1 15 00 00       	call   3938 <unlink>
  if(mkdir("dd") != 0){
    2357:	c7 04 24 15 49 00 00 	movl   $0x4915,(%esp)
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2372:	00 
    2373:	c7 04 24 4e 48 00 00 	movl   $0x484e,(%esp)
  ...
  write(fd, "ff", 2);
    ...
    2390:	00 
    2391:	c7 44 24 04 78 48 00 	movl   $0x4878,0x4(%esp)
    2398:	00 
  ...
  if(unlink("dd") >= 0){
    23a9:	c7 04 24 15 49 00 00 	movl   $0x4915,(%esp)
  ...
  if(mkdir("/dd/dd") != 0){
    23bd:	c7 04 24 29 48 00 00 	movl   $0x4829,(%esp)
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    23d8:	00 
    23d9:	c7 04 24 4b 48 00 00 	movl   $0x484b,(%esp)
  ...
  write(fd, "FF", 2);
    ...
    23f6:	00 
    23f7:	c7 44 24 04 6c 48 00 	movl   $0x486c,0x4(%esp)
    23fe:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2416:	00 
    2417:	c7 04 24 6f 48 00 00 	movl   $0x486f,(%esp)
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    2434:	00 
    2435:	c7 44 24 04 a0 7c 00 	movl   $0x7ca0,0x4(%esp)
    243c:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    244e:	80 3d a0 7c 00 00 66 	cmpb   $0x66,0x7ca0
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    2463:	c7 44 24 04 af 48 00 	movl   $0x48af,0x4(%esp)
    246a:	00 
    246b:	c7 04 24 4b 48 00 00 	movl   $0x484b,(%esp)
  ...
  if(unlink("dd/dd/ff") != 0){
    247f:	c7 04 24 4b 48 00 00 	movl   $0x484b,(%esp)
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    249a:	00 
    249b:	c7 04 24 4b 48 00 00 	movl   $0x484b,(%esp)
  ...
  if(chdir("dd") != 0){
    24af:	c7 04 24 15 49 00 00 	movl   $0x4915,(%esp)
  ...
  if(chdir("dd/../../dd") != 0){
    24c3:	c7 04 24 e3 48 00 00 	movl   $0x48e3,(%esp)
  ...
  if(chdir("dd/../../../dd") != 0){
    24d7:	c7 04 24 09 49 00 00 	movl   $0x4909,(%esp)
  ...
  if(chdir("./..") != 0){
    24eb:	c7 04 24 18 49 00 00 	movl   $0x4918,(%esp)
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    2506:	00 
    2507:	c7 04 24 af 48 00 00 	movl   $0x48af,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    2524:	00 
    2525:	c7 44 24 04 a0 7c 00 	movl   $0x7ca0,0x4(%esp)
    252c:	00 
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    254d:	00 
    254e:	c7 04 24 4b 48 00 00 	movl   $0x484b,(%esp)
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2569:	00 
    256a:	c7 04 24 63 49 00 00 	movl   $0x4963,(%esp)
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2585:	00 
    2586:	c7 04 24 88 49 00 00 	movl   $0x4988,(%esp)
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    25a1:	00 
    25a2:	c7 04 24 15 49 00 00 	movl   $0x4915,(%esp)
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    25bd:	00 
    25be:	c7 04 24 15 49 00 00 	movl   $0x4915,(%esp)
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    25d9:	00 
    25da:	c7 04 24 15 49 00 00 	movl   $0x4915,(%esp)
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    25ee:	c7 44 24 04 f7 49 00 	movl   $0x49f7,0x4(%esp)
    25f5:	00 
    25f6:	c7 04 24 63 49 00 00 	movl   $0x4963,(%esp)
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    260a:	c7 44 24 04 f7 49 00 	movl   $0x49f7,0x4(%esp)
    2611:	00 
    2612:	c7 04 24 88 49 00 00 	movl   $0x4988,(%esp)
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    2626:	c7 44 24 04 af 48 00 	movl   $0x48af,0x4(%esp)
    262d:	00 
    262e:	c7 04 24 4e 48 00 00 	movl   $0x484e,(%esp)
  ...
  if(mkdir("dd/ff/ff") == 0){
    2642:	c7 04 24 63 49 00 00 	movl   $0x4963,(%esp)
  ...
  if(mkdir("dd/xx/ff") == 0){
    2656:	c7 04 24 88 49 00 00 	movl   $0x4988,(%esp)
  ...
  if(mkdir("dd/dd/ffff") == 0){
    266a:	c7 04 24 af 48 00 00 	movl   $0x48af,(%esp)
  ...
  if(unlink("dd/xx/ff") == 0){
    267e:	c7 04 24 88 49 00 00 	movl   $0x4988,(%esp)
  ...
  if(unlink("dd/ff/ff") == 0){
    2692:	c7 04 24 63 49 00 00 	movl   $0x4963,(%esp)
  ...
  if(chdir("dd/ff") == 0){
    26a6:	c7 04 24 4e 48 00 00 	movl   $0x484e,(%esp)
  ...
  if(chdir("dd/xx") == 0){
    26ba:	c7 04 24 fa 49 00 00 	movl   $0x49fa,(%esp)
  ...
  if(unlink("dd/dd/ffff") != 0){
    26ce:	c7 04 24 af 48 00 00 	movl   $0x48af,(%esp)
  ...
  if(unlink("dd/ff") != 0){
    26e2:	c7 04 24 4e 48 00 00 	movl   $0x484e,(%esp)
  ...
  if(unlink("dd") == 0){
    26f6:	c7 04 24 15 49 00 00 	movl   $0x4915,(%esp)
  ...
  if(unlink("dd/dd") < 0){
    270a:	c7 04 24 2a 48 00 00 	movl   $0x482a,(%esp)
  ...
  if(unlink("dd") < 0){
    271e:	c7 04 24 15 49 00 00 	movl   $0x4915,(%esp)
  ...
  printf(1, "subdir ok\n");
    2732:	c7 44 24 04 f7 4a 00 	movl   $0x4af7,0x4(%esp)
    2739:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    printf(1, "dd/dd/../ff wrong content\n");
    274c:	c7 44 24 04 94 48 00 	movl   $0x4894,0x4(%esp)
    2753:	00 
  ...
  if(chdir("dd/../../../dd") != 0){
    printf(1, "chdir dd/../../dd failed\n");
    2765:	c7 44 24 04 ef 48 00 	movl   $0x48ef,0x4(%esp)
    276c:	00 
  ...
  if(unlink("dd/dd/ffff") != 0){
    printf(1, "unlink dd/dd/ff failed\n");
    277e:	c7 44 24 04 ba 48 00 	movl   $0x48ba,0x4(%esp)
    2785:	00 
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    printf(1, "create dd/ff/ff succeeded!\n");
    2797:	c7 44 24 04 6c 49 00 	movl   $0x496c,0x4(%esp)
    279e:	00 
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    27b0:	c7 44 24 04 0c 53 00 	movl   $0x530c,0x4(%esp)
    27b7:	00 
  ...
  if(mkdir("dd/ff/ff") == 0){
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    27c9:	c7 44 24 04 00 4a 00 	movl   $0x4a00,0x4(%esp)
    27d0:	00 
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    27e2:	c7 44 24 04 7c 53 00 	movl   $0x537c,0x4(%esp)
    27e9:	00 
  ...
  if(fd < 0){
    printf(1, "open dd/dd/../ff failed\n");
    27fb:	c7 44 24 04 7b 48 00 	movl   $0x487b,0x4(%esp)
    2802:	00 
  ...
  if(fd < 0){
    printf(1, "create dd/dd/ff failed\n");
    2814:	c7 44 24 04 54 48 00 	movl   $0x4854,0x4(%esp)
    281b:	00 
  ...
  if(chdir("./..") != 0){
    printf(1, "chdir ./.. failed\n");
    282d:	c7 44 24 04 1d 49 00 	movl   $0x491d,0x4(%esp)
    2834:	00 
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    2846:	c7 44 24 04 c4 52 00 	movl   $0x52c4,0x4(%esp)
    284d:	00 
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    285f:	c7 44 24 04 58 53 00 	movl   $0x5358,0x4(%esp)
    2866:	00 
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    2878:	c7 44 24 04 34 53 00 	movl   $0x5334,0x4(%esp)
    287f:	00 
  ...
  if(open("dd", O_WRONLY) >= 0){
    printf(1, "open dd wronly succeeded!\n");
    2891:	c7 44 24 04 dc 49 00 	movl   $0x49dc,0x4(%esp)
    2898:	00 
  ...
  if(open("dd", O_RDWR) >= 0){
    printf(1, "open dd rdwr succeeded!\n");
    28aa:	c7 44 24 04 c3 49 00 	movl   $0x49c3,0x4(%esp)
    28b1:	00 
  ...
  if(open("dd", O_CREATE) >= 0){
    printf(1, "create dd succeeded!\n");
    28c3:	c7 44 24 04 ad 49 00 	movl   $0x49ad,0x4(%esp)
    28ca:	00 
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    printf(1, "create dd/xx/ff succeeded!\n");
    28dc:	c7 44 24 04 91 49 00 	movl   $0x4991,0x4(%esp)
    28e3:	00 
  ...
  if(chdir("dd") != 0){
    printf(1, "chdir dd failed\n");
    28f5:	c7 44 24 04 d2 48 00 	movl   $0x48d2,0x4(%esp)
    28fc:	00 
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    290e:	c7 44 24 04 e8 52 00 	movl   $0x52e8,0x4(%esp)
    2915:	00 
  ...
  if(mkdir("/dd/dd") != 0){
    printf(1, "subdir mkdir dd/dd failed\n");
    2927:	c7 44 24 04 30 48 00 	movl   $0x4830,0x4(%esp)
    292e:	00 
  ...
  if(unlink("dd") >= 0){
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    2940:	c7 44 24 04 9c 52 00 	movl   $0x529c,0x4(%esp)
    2947:	00 
  ...
  if(fd < 0){
    printf(1, "create dd/ff failed\n");
    2959:	c7 44 24 04 14 48 00 	movl   $0x4814,0x4(%esp)
    2960:	00 
  ...
  if(mkdir("dd") != 0){
    printf(1, "subdir mkdir dd failed\n");
    2972:	c7 44 24 04 fc 47 00 	movl   $0x47fc,0x4(%esp)
    2979:	00 
  ...
  if(unlink("dd") < 0){
    printf(1, "unlink dd failed\n");
    298b:	c7 44 24 04 e5 4a 00 	movl   $0x4ae5,0x4(%esp)
    2992:	00 
  ...
  if(unlink("dd/dd") < 0){
    printf(1, "unlink dd/dd failed\n");
    29a4:	c7 44 24 04 d0 4a 00 	movl   $0x4ad0,0x4(%esp)
    29ab:	00 
  ...
  if(unlink("dd") == 0){
    printf(1, "unlink non-empty dd succeeded!\n");
    29bd:	c7 44 24 04 a0 53 00 	movl   $0x53a0,0x4(%esp)
    29c4:	00 
  ...
  if(unlink("dd/ff") != 0){
    printf(1, "unlink dd/ff failed\n");
    29d6:	c7 44 24 04 bb 4a 00 	movl   $0x4abb,0x4(%esp)
    29dd:	00 
  ...
  if(chdir("dd/xx") == 0){
    printf(1, "chdir dd/xx succeeded!\n");
    29ef:	c7 44 24 04 a3 4a 00 	movl   $0x4aa3,0x4(%esp)
    29f6:	00 
  ...
  if(chdir("dd/ff") == 0){
    printf(1, "chdir dd/ff succeeded!\n");
    2a08:	c7 44 24 04 8b 4a 00 	movl   $0x4a8b,0x4(%esp)
    2a0f:	00 
  ...
  if(unlink("dd/ff/ff") == 0){
    printf(1, "unlink dd/ff/ff succeeded!\n");
    2a21:	c7 44 24 04 6f 4a 00 	movl   $0x4a6f,0x4(%esp)
    2a28:	00 
  ...
  if(unlink("dd/xx/ff") == 0){
    printf(1, "unlink dd/xx/ff succeeded!\n");
    2a3a:	c7 44 24 04 53 4a 00 	movl   $0x4a53,0x4(%esp)
    2a41:	00 
  ...
  if(mkdir("dd/dd/ffff") == 0){
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    2a53:	c7 44 24 04 36 4a 00 	movl   $0x4a36,0x4(%esp)
    2a5a:	00 
  ...
  if(mkdir("dd/xx/ff") == 0){
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    2a6c:	c7 44 24 04 1b 4a 00 	movl   $0x4a1b,0x4(%esp)
    2a73:	00 
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    printf(1, "read dd/dd/ffff wrong len\n");
    2a85:	c7 44 24 04 48 49 00 	movl   $0x4948,0x4(%esp)
    2a8c:	00 
  ...
  if(fd < 0){
    printf(1, "open dd/dd/ffff failed\n");
    2a9e:	c7 44 24 04 30 49 00 	movl   $0x4930,0x4(%esp)
    2aa5:	00 
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
    2ac6:	a1 c4 54 00 00       	mov    0x54c4,%eax
    2acb:	c7 44 24 04 02 4b 00 	movl   $0x4b02,0x4(%esp)
    2ad2:	00 
    2ad3:	89 04 24             	mov    %eax,(%esp)
    2ad6:	e8 55 0f 00 00       	call   3a30 <printf>

  if(mkdir("dir0") < 0){
    2adb:	c7 04 24 0e 4b 00 00 	movl   $0x4b0e,(%esp)
  ...
  if(chdir("dir0") < 0){
    2aeb:	c7 04 24 0e 4b 00 00 	movl   $0x4b0e,(%esp)
  ...
  if(chdir("..") < 0){
    2aff:	c7 04 24 1a 49 00 00 	movl   $0x491a,(%esp)
  ...
  if(unlink("dir0") < 0){
    2b0f:	c7 04 24 0e 4b 00 00 	movl   $0x4b0e,(%esp)
  ...
  printf(stdout, "mkdir test\n");
    2b1f:	a1 c4 54 00 00       	mov    0x54c4,%eax
    2b24:	c7 44 24 04 02 4b 00 	movl   $0x4b02,0x4(%esp)
    2b2b:	00 
...
void dirtest(void)
{
  ...
  if(mkdir("dir0") < 0){
    printf(stdout, "mkdir failed\n");
    2b36:	a1 c4 54 00 00       	mov    0x54c4,%eax
    2b3b:	c7 44 24 04 13 4b 00 	movl   $0x4b13,0x4(%esp)
    2b42:	00 
  ...
  if(unlink("dir0") < 0){
    printf(stdout, "unlink dir0 failed\n");
    2b50:	a1 c4 54 00 00       	mov    0x54c4,%eax
    2b55:	c7 44 24 04 45 4b 00 	movl   $0x4b45,0x4(%esp)
    2b5c:	00 
  ...
  if(chdir("..") < 0){
    printf(stdout, "chdir .. failed\n");
    2b6a:	a1 c4 54 00 00       	mov    0x54c4,%eax
    2b6f:	c7 44 24 04 34 4b 00 	movl   $0x4b34,0x4(%esp)
    2b76:	00 
  ...
  if(chdir("dir0") < 0){
    printf(stdout, "chdir dir0 failed\n");
    2b84:	a1 c4 54 00 00       	mov    0x54c4,%eax
    2b89:	c7 44 24 04 21 4b 00 	movl   $0x4b21,0x4(%esp)
    2b90:	00 
...
bigfile(void)
{
  ...
  for(i = 0; i < 20; i++){
    ...
    2bfc:	c7 04 24 a0 7c 00 00 	movl   $0x7ca0,(%esp)
    2c03:	e8 58 0b 00 00       	call   3760 <memset>
    if(write(fd, buf, 600) != 600){
    2c08:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
    2c0f:	00 
    2c10:	c7 44 24 04 a0 7c 00 	movl   $0x7ca0,0x4(%esp)
    2c17:	00 
  ...
  fd = open("bigfile", 0);
    ...
    2c42:	00 
    2c43:	c7 04 24 75 4b 00 00 	movl   $0x4b75,(%esp)
  ...
  if(fd < 0){
    ...
    2c6b:	0f be 05 a0 7c 00 00 	movsbl 0x7ca0,%eax
    2c72:	89 da                	mov    %ebx,%edx
    2c74:	d1 fa                	sar    %edx
    2c76:	39 d0                	cmp    %edx,%eax
    2c78:	75 6f                	jne    2ce9 <bigfile+0x149>
    2c7a:	0f be 15 cb 7d 00 00 	movsbl 0x7dcb,%edx
  ...
  for(i = 0; ; i++){
    ...
    2c95:	00 
    2c96:	c7 44 24 04 a0 7c 00 	movl   $0x7ca0,0x4(%esp)
    2c9d:	00 
  ...
  unlink("bigfile");
    2cc1:	c7 04 24 75 4b 00 00 	movl   $0x4b75,(%esp)
    2cc8:	e8 6b 0c 00 00       	call   3938 <unlink>

  printf(1, "bigfile test ok\n");
    2ccd:	c7 44 24 04 04 4c 00 	movl   $0x4c04,0x4(%esp)
    2cd4:	00 
    ...
    if(buf[0] != i/2 || buf[299] != i/2){
      printf(1, "read bigfile wrong data\n");
    2ce9:	c7 44 24 04 d1 4b 00 	movl   $0x4bd1,0x4(%esp)
    2cf0:	00 
    ...
    if(cc != 300){
      printf(1, "short read bigfile\n");
    2d02:	c7 44 24 04 bd 4b 00 	movl   $0x4bbd,0x4(%esp)
    2d09:	00 
  ...
  for(i = 0; ; i++){
    ...
    if(cc < 0){
      printf(1, "read bigfile failed\n");
    2d1b:	c7 44 24 04 a8 4b 00 	movl   $0x4ba8,0x4(%esp)
    2d22:	00 
  ...
  for(i = 0; i < 20; i++){
    ...
    if(write(fd, buf, 600) != 600){
      printf(1, "write bigfile failed\n");
    2d34:	c7 44 24 04 7d 4b 00 	movl   $0x4b7d,0x4(%esp)
    2d3b:	00 
  ...
  if(fd < 0){
    printf(1, "cannot open bigfile\n");
    2d4d:	c7 44 24 04 93 4b 00 	movl   $0x4b93,0x4(%esp)
    2d54:	00 
  ...
  if(fd < 0){
    printf(1, "cannot create bigfile");
    2d66:	c7 44 24 04 67 4b 00 	movl   $0x4b67,0x4(%esp)
    2d6d:	00 
  ...
  if(total != 20*600){
    printf(1, "read bigfile wrong total\n");
    2d7f:	c7 44 24 04 ea 4b 00 	movl   $0x4bea,0x4(%esp)
    2d86:	00 
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    2dab:	c7 44 24 04 15 4c 00 	movl   $0x4c15,0x4(%esp)
    2db2:	00 
  ...
  for(i = 0; i < 40; i++){
    ...
    2e54:	c7 04 24 25 4c 00 00 	movl   $0x4c25,(%esp)
  ...
  for(i = 0; i < 40; i++){
    ...
    2e6f:	c7 04 24 25 4c 00 00 	movl   $0x4c25,(%esp)
  ...
  fd = open(".", 0);
    ...
    2ead:	00 
    2eae:	c7 04 24 1b 49 00 00 	movl   $0x491b,(%esp)
  ...
  printf(1, "concreate ok\n");
    3020:	c7 44 24 04 7a 4c 00 	movl   $0x4c7a,0x4(%esp)
    3027:	00 
  ...
  for(i = 0; i < 40; i++){
    ...
    if(pid < 0){
      printf(1, "fork failed\n");
    303c:	c7 44 24 04 ba 3f 00 	movl   $0x3fba,0x4(%esp)
    3043:	00 
    ...
    3059:	c7 44 24 04 28 4c 00 	movl   $0x4c28,0x4(%esp)
    3060:	00 
    ...
    3079:	c7 44 24 04 44 4c 00 	movl   $0x4c44,0x4(%esp)
    3080:	00 
  ...
  if(n != 40){
    printf(1, "concreate not enough files in directory listing\n");
    3092:	c7 44 24 04 c0 53 00 	movl   $0x53c0,0x4(%esp)
    3099:	00 
    ...
    30b2:	c7 44 24 04 5d 4c 00 	movl   $0x4c5d,0x4(%esp)
    30b9:	00 
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
    30d9:	c7 44 24 04 88 4c 00 	movl   $0x4c88,0x4(%esp)
    30e0:	00 
    30e1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30e8:	e8 43 09 00 00       	call   3a30 <printf>

  unlink("f1");
    30ed:	c7 04 24 fa 41 00 00 	movl   $0x41fa,(%esp)
    30f4:	e8 3f 08 00 00       	call   3938 <unlink>
  unlink("f2");
    30f9:	c7 04 24 fe 41 00 00 	movl   $0x41fe,(%esp)
  ...
  fname = pid ? "f1" : "f2";
    3115:	ba fa 41 00 00       	mov    $0x41fa,%edx
    311a:	b8 fe 41 00 00       	mov    $0x41fe,%eax
  ...
  memset(buf, pid?'p':'c', 512);
    ...
    3155:	c7 04 24 a0 7c 00 00 	movl   $0x7ca0,(%esp)
  ...
  for(i = 0; i < 12; i++){
    ...
    316f:	00 
    3170:	c7 44 24 04 a0 7c 00 	movl   $0x7ca0,0x4(%esp)
    3177:	00 
  ...
  if(pid)
    ...
    31aa:	b8 fe 41 00 00       	mov    $0x41fe,%eax
  else
    exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    31d2:	00 
    31d3:	c7 44 24 04 a0 7c 00 	movl   $0x7ca0,0x4(%esp)
    31da:	00 
    ...
    31f3:	0f be b9 a0 7c 00 00 	movsbl 0x7ca0(%ecx),%edi
  ...
  for(i = 0; i < 2; i++){
    ...
    if(total != 12*500){
      ...
      exit();
    322b:	b8 fa 41 00 00       	mov    $0x41fa,%eax
  if(pid)
    wait();
  else
    exit();
  ...
  unlink("f2");
    323a:	c7 04 24 fe 41 00 00 	movl   $0x41fe,(%esp)
    3241:	e8 f2 06 00 00       	call   3938 <unlink>

  printf(1, "twofiles ok\n");
    3246:	c7 44 24 04 c5 4c 00 	movl   $0x4cc5,0x4(%esp)
    324d:	00 
  ...
  if(pid)
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
      for(j = 0; j < n; j++){
        if(buf[j] != (i?'p':'c')){
          printf(1, "wrong char\n");
    326c:	c7 44 24 04 a8 4c 00 	movl   $0x4ca8,0x4(%esp)
    3273:	00 
  ...
  for(i = 0; i < 12; i++){
    ...
    3289:	c7 44 24 04 97 4c 00 	movl   $0x4c97,0x4(%esp)
    3290:	00 
  ...
  if(pid < 0){
    printf(1, "fork failed\n");
    32a2:	c7 44 24 04 ba 3f 00 	movl   $0x3fba,0x4(%esp)
    32a9:	00 
  ...
  if(fd < 0){
    printf(1, "create failed\n");
    32bb:	c7 44 24 04 c3 40 00 	movl   $0x40c3,0x4(%esp)
    32c2:	00 
    ...
    32d8:	c7 44 24 04 b4 4c 00 	movl   $0x4cb4,0x4(%esp)
    32df:	00 
...
sharedfd(void)
{
  ...
  for(i = 0; i < 1000; i++){
    ...
    339c:	c7 44 24 04 20 54 00 	movl   $0x5420,0x4(%esp)
    33a3:	00 
  ...
  fd = open("sharedfd", 0);
    ...
    33d3:	00 
    33d4:	c7 04 24 e1 4c 00 00 	movl   $0x4ce1,(%esp)
  ...
  unlink("sharedfd");
    343c:	c7 04 24 e1 4c 00 00 	movl   $0x4ce1,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    3458:	c7 44 24 04 ea 4c 00 	movl   $0x4cea,0x4(%esp)
    345f:	00 
  ...
  if(fd < 0){
    printf(1, "fstests: cannot open sharedfd for writing");
    3474:	c7 44 24 04 f4 53 00 	movl   $0x53f4,0x4(%esp)
    347b:	00 
  ...
  if(fd < 0){
    printf(1, "fstests: cannot open sharedfd for reading\n");
    3490:	c7 44 24 04 40 54 00 	movl   $0x5440,0x4(%esp)
    3497:	00 
  ...
  if(nc == 10000 && np == 10000){
    ...
    34ae:	c7 44 24 04 f7 4c 00 	movl   $0x4cf7,0x4(%esp)
    34b5:	00 
...
mem(void)
{
  ...
  printf(1, "mem test\n");
    34db:	c7 44 24 04 0c 4d 00 	movl   $0x4d0c,0x4(%esp)
    34e2:	00 
  ...
  if((pid = fork()) == 0){
    ...
    printf(1, "mem ok\n");
    3548:	c7 44 24 04 30 4d 00 	movl   $0x4d30,0x4(%esp)
    354f:	00 
    ...
    if(m1 == 0){
      printf(1, "couldn't allocate mem?!!\n");
    3570:	c7 44 24 04 16 4d 00 	movl   $0x4d16,0x4(%esp)
    3577:	00 
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    35a9:	c7 44 24 04 38 4d 00 	movl   $0x4d38,0x4(%esp)
    35b0:	00 
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    35f7:	00 
    35f8:	c7 04 24 4c 4d 00 00 	movl   $0x4d4c,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    39ca:	f7 f7                	div    %edi
    39cc:	0f b6 92 9f 54 00 00 	movzbl 0x549f(%edx),%edx
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    3b60:	8b 55 d4             	mov    -0x2c(%ebp),%edx
        ap++;
        if(s == 0)
    3b63:	b9 98 54 00 00       	mov    $0x5498,%ecx
        ap++;
      } else if(c == 'x' || c == 'p'){
        printint(fd, *ap, 16, 0);
        ap++;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3c21:	a1 68 55 00 00       	mov    0x5568,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  freep = p;
    3c71:	a3 68 55 00 00       	mov    %eax,0x5568
}
    3c76:	5b                   	pop    %ebx
    3c77:	5e                   	pop    %esi
    3c78:	5f                   	pop    %edi
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    3c9d:	a3 68 55 00 00       	mov    %eax,0x5568
}
    3ca2:	5b                   	pop    %ebx
    3ca3:	5e                   	pop    %esi
    3ca4:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3cbc:	8b 0d 68 55 00 00    	mov    0x5568,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
    ...
    if(p == freep)
    3cf0:	3b 05 68 55 00 00    	cmp    0x5568,%eax
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    3d0f:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
    3d12:	89 0d 68 55 00 00    	mov    %ecx,0x5568
      return (void*)(p + 1);
...
morecore(uint nu)
{
  ...
  return freep;
    3d57:	8b 0d 68 55 00 00    	mov    0x5568,%ecx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    3d6e:	c7 05 68 55 00 00 60 	movl   $0x5560,0x5568
    3d75:	55 00 00 
    base.s.size = 0;
    3d78:	b9 60 55 00 00       	mov    $0x5560,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    3d7d:	c7 05 60 55 00 00 60 	movl   $0x5560,0x5560
    3d84:	55 00 00 
    base.s.size = 0;
    3d87:	c7 05 64 55 00 00 00 	movl   $0x0,0x5564
    3d8e:	00 00 00 
...
int ring_detach(uint token)
{
  ...
  return 0;
    ...
    3dc5:	5d                   	pop    %ebp
    3dc6:	c3                   	ret    
    3dc7:	89 f6                	mov    %esi,%esi
    3dc9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00003dd0 <ring_write_reserve>:
...
struct ring_res ring_write_reserve(struct ring *r, int bytes)
{
  ...
  return ret;
    3dd6:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    3ddd:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
    3de3:	5d                   	pop    %ebp
    3de4:	c2 04 00             	ret    $0x4
    3de7:	89 f6                	mov    %esi,%esi
    3de9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00003df0 <ring_write_notify>:
...
struct ring_res ring_read_reserve(struct ring *r, int bytes)
{
  ...
  struct ring_res ret = {0, 0};
  return ret;
    3e06:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    3e0d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
    3e13:	5d                   	pop    %ebp
    3e14:	c2 04 00             	ret    $0x4
    3e17:	89 f6                	mov    %esi,%esi
    3e19:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00003e20 <ring_read_notify>:
...
void ring_read_notify(struct ring *r, int bytes)
{
    ...
    3e23:	5d                   	pop    %ebp
    3e24:	c3                   	ret    
    3e25:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
...
void ring_write(struct ring *r, void *buf, int bytes)
{
    ...
    3e33:	5d                   	pop    %ebp
    3e34:	c3                   	ret    
    3e35:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
